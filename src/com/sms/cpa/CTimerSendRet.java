...
// Source File Name:   CTimerSendRet.java
...
public class CTimerSendRet extends CParam
    implements Serializable
{

    public CTimerSendRet(String sUser)
    {
        super((byte)-110, sUser);
        bStatus = 0;
        sMsg = "";
    }

    public CTimerSendRet(byte b[])
        throws Exception
    {
        super(b);
        bStatus = 0;
        sMsg = "";
        if(super.bCommand != -110)
        {
    ...
    public static final byte CMD = -110;
