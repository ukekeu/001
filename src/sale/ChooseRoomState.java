...
public class ChooseRoomState {
	private static Logger logger = LoggerFactory
			.getLogger(ChooseRoomState.class);
	public int day = 0;
	public int fg = 0;
	...
	public String BeanshowLoft(String paramString1,
		...
		try {
			...
			localResultSet1 = localSDatabase.executeQuery(this.sql);
	...
	public String BeanCodeShow(String paramString1, String paramString2) {
		...
		try {
			...
			if (!this.Loft.equals(""))
				str1 = str1 + " and Loft in (" + this.Loft + ") ";
			...
			if (!this.Loft.equals("")) {
				while (localResultSet1.next()) {
					...
					String str2 = "";
					if (!this.Loft.equals(""))
						str2 = " and loft='" + this.Loft + "'";

					String str3 = "select lockroom from lockroom where section ='"
							+ this.strSection + "' and ";
					...
					try {
						...
						while (localResultSet2.next()) {
							...
							if (!Character.isDigit(c1)) {
								str4 = String.valueOf(Character
										.getNumericValue(c1) - 9);
							}
					...
					this.sql = (this.sql + " RoomNo where SectionNo='"
							+ this.strSection + "'");
					this.sql = (this.sql + "  and Region='" + this.Loft + "' and floor=0");
					ResultSet localResultSet3 = localSDatabase2
					...
					String str9 = "";
					int i5 = 20;
					String str10 = "select room_type,ts from LoftBuildCode where SECNO='"
							+ this.strSection
							+ "' and loft='"
							+ this.Loft
							+ "'";

					ResultSet localResultSet4 = localSDatabase2
							.executeQuery(str10);
					...
					String str11 = "";
					localResultSet3 = localSDatabase2
							.executeQuery("select roomtype from LoftBuildCode where SecNo='"
									+ this.strSection
									+ "' and Loft='"
									+ this.Loft + "' and roomtype=1");
					if (localResultSet3.next()) {
						str11 = "1";
					}
					localResultSet3.close();
					...
					if (!this.strSection.equals("")) {
						String str18 = "select  *  from SaleStateColor WHERE secno='"
								+ this.strSection + "'";

						ResultSet localResultSet5 = localSDatabase2
								.executeQuery(str18);
					...
					if (!this.SecName.equals(this.Loft))
						this.alertmess += this.SecName;
					this.alertmess = (this.alertmess + this.Loft + " 销控表</font></b></p>");
					...
					this.alertmess += " </td>";
					this.alertmess += "</tr>";
					this.alertmess = (this.alertmess + " <tr><td bgcolor='"
							+ str17 + "' align=\"center\"><div id=wy" + i + "></div></td>");
					this.alertmess = (this.alertmess + "<td bgcolor='" + str12
							+ "'  align=\"center\"><div id=ry" + i + "></div></td>");
					this.alertmess = (this.alertmess
							+ "  <td   align=\"center\"><div id=sum" + i + "> </div>");
					this.alertmess += " </td>";
					this.alertmess += " \t</tr>";
					this.alertmess = (this.alertmess + "  <tr><td bgcolor='"
							+ str17 + "' align=\"center\"><div id=w1" + i + "></div></td>");
					this.alertmess = (this.alertmess + " <td bgcolor='" + str12
							+ "'  align=\"center\"><div id=r1" + i + "></div></td>");
					this.alertmess += " </td>";
					this.alertmess += " <td   align=\"center\"> ";
					this.alertmess += " </td>";
					this.alertmess += " </tr>";
					...
					str22 = str22 + this.strBuilding + "' and loft='"
							+ this.Loft + "'  ";
					ResultSet localResultSet6 = localSDatabase2
							.executeQuery(str22);
					if (localResultSet6.next())
						str21 = localResultSet6.getString("Room_code");
					...
					if (str21.equals("")) {
						...
						for (int i13 = i3; i13 <= i4; i13++) {
							...
							str30 = str30 + str2 + " and  a.cell='" + str8
									+ "' and a.floortype=0    order by a.Floor";
							ResultSet localResultSet7 = localSDatabase2
									.executeQuery(str30);
							int i14 = 0;
							while (localResultSet7.next()) {
								localLinkedList8.add(localResultSet7
										.getString("Room_code"));
								localLinkedList3.add(localResultSet7
										.getString("SaleState"));
								String str31 = localResultSet7
										.getString("Floor");
								String str32 = localResultSet7
										.getString("Room");
								...
								if (Integer.parseInt(str32) >= 10)
									...
									localLinkedList2.add(str8 + str31 + "0"
											+ str32);
								}
								localLinkedList6.add(getbyte1(localResultSet7
										.getString("area")));
								localLinkedList7.add(localResultSet7
										.getString("code"));
								localLinkedList9.add(getbyte1(localResultSet7
										.getString("floormess")));
								localLinkedList10.add(getbyte1(localResultSet7
										.getString("showfloors")));
								localLinkedList11.add(localResultSet7
										.getString("dis"));
								localLinkedList12.add(getbyte1(localResultSet7
										.getString("tddate")));
								localLinkedList13.add(getbyte1(localResultSet7
										.getString("sumprice")));
							}
							...
							if (!str8.equals(""))
								this.alertmess = (this.alertmess + str8 + "单元");
							...
							if ((str9.indexOf("墅") < 0)
								...
								for (int i18 = n; i18 <= i1; i18++) {
									...
									if ((((String) localObject2).indexOf(String
											.valueOf(i18)) >= 0)
											|| (str20
													.indexOf((String) localObject2) >= 0)) {
										if (str20
												.indexOf((String) localObject2) >= 0) {
											if (!localLinkedList1
													.contains(String
												...
												this.alertmess = (this.alertmess
														+ "   width=\"5%\"><font color=\"#ffffff\">"
														+ str33 + "</font></td>");
											}
										} else if (!localLinkedList1
												.contains(String.valueOf(i18))) {
											this.alertmess += "  <td align=\"center\" class=listtitle ";
											this.alertmess += "   colspan='2'";
											this.alertmess = (this.alertmess
													+ "   width=\"5%\"><font color=\"#ffffff\">"
							...
							for (int i17 = k; i17 <= m; i17++) {
								...
								if ((str9.indexOf("墅") < 0)
										&& (str9.indexOf("车") < 0))
									this.alertmess = (this.alertmess
											+ "  <td align=\"center\" class=FloorC width=\"1%\"><font color=\"#ffffff\"><div id=A"
											+ String.valueOf(Math.abs(i17)) + 1
											+ "w1>" + i17 + "</div></font></td>");
								else {
									this.alertmess = (this.alertmess
								...
								for (i19 = n; i19 <= i1; i19++) {
									...
									if (!localLinkedList1.contains(String
											.valueOf(i19))) {
										i16++;
										this.no = "";
										str34 = "";
										...
										str37 = "";
										if (i19 >= 10)
											str34 = str8 + String.valueOf(i17)
													+ String.valueOf(i19);
										else
											str34 = str8 + String.valueOf(i17)
													+ "0" + String.valueOf(i19);
										i15++;

										if (localLinkedList2.contains(str34)) {
											int i21 = localLinkedList2
													.indexOf(str34);
											this.state = getbyte((String) localLinkedList3
													.get(i21));

											str34 = (String) localLinkedList8
													.get(i21);
											str26 = (String) localLinkedList9
													.get(i21);
											str24 = (String) localLinkedList10
													.get(i21);
											if (this.state.equals("1"))
												try {
													str27 = (String) localLinkedList7
															.get(i21);
													str28 = (String) localLinkedList6
															.get(i21);
													String str39 = (String) localLinkedList13
															.get(i21);
													if ((str27.equals(""))
															|| (str27 == null))
														str27 = "0";
										...
										if (this.condi.equals("wen")) {
											...
											if (this.state.equals("2"))
												str34 = this.no
														+ "<img src='../images/mypw.gif' border='0' >";
											else if (this.state.equals("3"))
												str34 = this.no
														+ "<img src='../images/maIcon.gif' border='0'  >";
											else if (this.state.equals("1"))
												str34 = this.no
														+ "&nbsp;&nbsp;";
											else if (this.state.equals("5"))
												str34 = this.no
														+ "<img src='../images/day2.gif' border='0' >";
											else if (this.state.equals("2"))
												str34 = this.no;
											else if (this.state.equals("4"))
												str34 = this.no
														+ "<img src='../images/face39.gif' border='0' >";
										...
										if (this.state.equals("1")) {
											this.alertmess = (this.alertmess
													+ "  <input type=checkbox name=chooseroom ylloft='"
													+ this.Loft + "' value='"
													+ str27 + "'>");
											i6++;
										} else {
								...
								this.alertmess = (this.alertmess
										+ "  <script>A"
										+ String.valueOf(Math.abs(i17)) + 1 + "w1.innerHTML=\"");
								if (!str26.equals(""))
									this.alertmess = (this.alertmess
											+ String.valueOf(i17) + str26);
								else
									this.alertmess += i17;
								this.alertmess += "\" ;</script>";
							...
							for (int i17 = i2; i17 <= -1; i17++) {
								...
								for (i19 = n; i19 <= i1; i19++) {
									if (!localLinkedList1.contains(String
										...
										if (localLinkedList2.contains(str34)) {
											int i20 = localLinkedList2
													.indexOf(str34);
											this.state = ((String) localLinkedList3
													.get(i20));
											str34 = (String) localLinkedList8
													.get(i20);
											str26 = (String) localLinkedList9
											...
											if (this.state.equals("1"))
												try {
													...
													str28 = (String) localLinkedList6
															.get(i20);
													str37 = (String) localLinkedList13
															.get(i20);
													if ((str27.equals(""))
															|| (str27 == null))
														str27 = "0";
										...
										if (((i17 != 3) || (i19 != 4))
												|| (this.state.equals("1")))
											str36 = "BGCOLOR='#DDE8E8'";
										if (this.state.equals("2"))
											str36 = "bgcolor='#00CCFF'";
										if (this.state.equals("3"))
											str36 = "bgcolor='#E5C862'";
										if (this.state.equals("4"))
											str36 = "bgcolor='#8DE4A6'";
										if (this.state.equals("5"))
											str36 = "bgcolor='#FF00FF'";
										if (this.state.equals("6"))
											str36 = "bgcolor='#AACC6F'";
					...
					this.alertmess = (this.alertmess + "  wy" + i
							+ ".innerHTML = \"" + i6 + "\";");
					this.alertmess = (this.alertmess
							+ " w1"
							+ i
							+ ".innerHTML = \""
							+ localFormatData.getFloat(
									Float.parseFloat(String.valueOf(i6))
											/ (i11 + i6 + i10 + i8 + i7)
											* 100.0F, 2) + "%\";");
					this.alertmess = (this.alertmess + " ry" + i
							+ ".innerHTML = \"" + i7 + "\";");
					int i13 = i11 + i6 + i10 + i8 + i7 + i9;
					this.alertmess = (this.alertmess + " sum" + i
							+ ".innerHTML = '合计：" + i13 + "';");
					this.alertmess += "</script>";
					this.alertmess += "  </td>";
				}
			...
			SDatabase.closeConn(localResultSet1, null, localSDatabase1.conn);
			SDatabase.closeConn(localResultSet2, null, localSDatabase2.conn);
		}
	...
	public String BeanCodeShow1(String paramString1, String paramString2) {
		...
		try {
			...
			if (!this.Loft.equals("")) {
				while (localResultSet1.next()) {
					...
					try {
						...
						SDatabase.closeConn(localResultSet2, null, null);
					}
					this.sql = "select floor from";
					this.sql = (this.sql + " RoomNo where SectionNo='"
							+ this.strSection + "'");
					...
					String str10 = "";
					int i5 = 20;
					String str11 = "select room_type,ts from LoftBuildCode where SECNO='"
							+ this.strSection
							+ "' and loft='"
							+ this.Loft
							+ "'";
			...
			SDatabase.closeConn(localResultSet1, null, localSDatabase1.conn);
			SDatabase.closeConn(localResultSet2, null, localSDatabase2.conn);
			SDatabase.closeConn(localResultSet3, null, null);
		}
		return this.alertmess;
	}
								...
								for (i19 = n; i19 <= i1; i19++) {
									...
									if (!localLinkedList1.contains(String
										...
										if ((!this.state.equals("2"))
												...
												&& (!this.state.equals("")))
											this.alertmess = (this.alertmess
													+ " <a href='#aa' onclick=\"openwinzy('zy2.jsp?code="
													+ str27 + "',650,450,100,100);\">打印</a> ");
										this.alertmess += "</td> ";
									}
