...
public class menu
{
  ...
  public String showregCompay()
  {
    ...
    try {
      ...
      localResultSet = localSDatabase.executeQuery("select CompanyName from company");
      ...
      this.outStr = (this.outStr + " window.status=\"本产品是U客软件授权给" + str + "合法使用" + "\";");
      this.outStr += "}";
  ...
  public String showProduect() {
    ...
    ResultSet localResultSet = null;
    try { localResultSet = localSDatabase1.executeQuery(str);
      ...
      if (localResultSet.next()) {
        ...
        this.outStr += "   </tr>  ";
        this.outStr += "  <tr>";
        this.outStr = (this.outStr + "   <td width='100%'>正式注册日期：" + localResultSet.getString("column_b") + "</td>");
        this.outStr += " </tr>";
        this.outStr += " <tr>";
        this.outStr = (this.outStr + "  <td width='100%'>正式注册号码：" + localResultSet.getString("userregno") + "</td>");
        this.outStr += " </tr>";
        this.outStr += "<tr>";
        this.outStr = (this.outStr + "   <td width='100%'>软件版本号码：" + localResultSet.getString("softver") + "</td>");
        this.outStr += " </tr>";
        this.outStr += "<tr>";
        this.outStr = (this.outStr + "   <td width='100%'>软件版本条码：" + localResultSet.getString("code") + "</td>");
        this.outStr += " </tr>";
        this.outStr += "   <tr>";
        this.outStr = (this.outStr + "    <td width='100%'>软件版权属于：" + localResultSet.getString("saleperson") + "</td>");
        this.outStr += "  </tr>";
        this.outStr += "</table>";
  ...
  public String newLeftMenu(String paramString1, String paramString2)
  {
    ...
    try {
      ...
      String str = "select Url,MModuleNo,CModuleNo,MModuleName,picpath,nexus,title  from ModuleCortrol where  nexus='P' and   MModuleNo<>'desktop' and  MModuleNo in(select manModule from  ManModuleCortrol where SellerId='" + paramString1 + "') ORDER BY orderby  ";
      ...
      while (localResultSet1.next()) {
        ...
        this.outStr = (this.outStr + "  <td  height=\"30\" valign=\"middle\" id=upto" + String.valueOf(i) + " background=\"../images/new/Over.jpg\" onclick=\"open_close(" + i + " );open_close1(" + i + " );window.parent.main.location='../" + localResultSet1.getString("Url") + "';window.parent.banner.showwz.innerHTML='<font color=#FFFFFF>当前位置:" + localResultSet1.getString("MModuleName") + "</font>';\"  >");
        this.outStr = (this.outStr + "<font color=\"#FFFFFF\">" + localResultSet1.getString("MModuleName") + " </font>");
        this.outStr += " </td>";
        this.outStr += "</tr><tr>";
        ...
        str = "select Url,MModuleNo,MModuleName,CModuleNo,CModuleName,small,nexus,title  from ModuleCortrol where   nexus='C' and  MModuleNo ='" + localResultSet1.getString("MModuleNo") + "' and CModuleNo in(select ModuleNo from  PopedomConrtrol where SellerId='" + paramString1 + "') ORDER BY nexus DESC, orderby";
        ResultSet localResultSet2 = null;
        localResultSet2 = localSDatabase2.executeQuery(str);
        while (localResultSet2.next()) {
          this.outStr = (this.outStr + "  <tr   height='30'    align=center> <td background=''  valign='middle' ><img  src='" + localResultSet2.getString("small") + "' border='0' width='16' height='16'>&nbsp;<a href='#' onclick=\"window.parent.main.location='../" + localResultSet2.getString("Url") + "';window.parent.banner.showwz.innerHTML='<font color=#FFFFFF>当前位置:" + localResultSet1.getString("MModuleName") + "-->" + localResultSet2.getString("CModuleName") + "</font>';\" ><font color='#FFFFFF'>" + localResultSet2.getString("CModuleName") + "</font></a></td></tr>");
        }
  ...
  public String newTopMenu(String paramString1, String paramString2)
  {
    ...
    String str4 = "";
    try {
      ResultSet localResultSet = localSDatabase1.executeQuery("select servicephone,serviceperson,saleurl,saleperson from  user_reg");
      if (localResultSet.next()) {
    ...
    if (localregcheck.state == 1)
      this.outStr = (this.outStr + "title='软件提供商：U客软件　          　正式注册编码：hcrm-" + localregcheck.userregno + "'");
    this.outStr += ">";
    this.outStr += " <TBODY>";
    ...
    this.outStr = (this.outStr + "               <td   onMouseOut=\"MM_swapImgRestore();\" onMouseOver=\"mout(this);MM_swapImage('Image12','','../images/new/F2_r1_c4.jpg',1);\" title='技术支持联系人:" + str2 + ",电话:" + str1 + "'><img src=\"../images/new/F_r2_c9.jpg\" name=\"Image12\" width=\"72\" height=\"43\" border=\"0\"></td>");
    this.outStr = (this.outStr + "               <td   onMouseOut=\"MM_swapImgRestore();\" onMouseOver=\"mout(this);MM_swapImage('Image13','','../images/new/F2_r1_c5.jpg',1);\" title='" + str4 + "' onclick=\"window.open('http://" + str3 + "');return false;\" ><img src=\"../images/new/F_r2_c10.jpg\" name=\"Image13\" width=\"69\" height=\"43\" border=\"0\"></td>");
    ...
    this.outStr += "         </TD></TR>";
    this.outStr += "     </TBODY></TABLE> ";
    if (localregcheck.fg == 0) this.outStr = localregcheck.alertmess; else
      checkREG();
    return this.outStr;
  }
  ...
  public String doleftmenuStart(String paramString1, String paramString2)
  {
    ...
    String str1 = "select Url,MModuleNo,CModuleNo,MModuleName,picpath,nexus,title  from ModuleCortrol where  nexus='P' and  MModuleNo in(select manModule from  ManModuleCortrol where SellerId='" + paramString1 + "') ORDER BY orderby  ";
    ResultSet localResultSet = null;
    int i = 1;
    ...
    try {
      ...
      while (localResultSet.next()) {
        ...
        if (getbyte(localResultSet.getString("CModuleNo")).trim().equals("desktop")) str2 = "rigthmenu.jsp?MModuleNo=DESKTOP"; else {
          str2 = "welcome.jsp";
        }
        this.outStr = (this.outStr + "  <tr   height='30'   align=center> <td background='' onclick=\"window.parent.main.location='rigthmenu.jsp?MModuleNo=" + str6 + "';menupic(this);windowstate('" + str4 + "');changeclass(this,'L3','L2');\"  ><a href  onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style=\"cursor:hand;\"    border=0 >" + str4 + "</a></td></tr>");
      }
  ...
  public String doleftmenuPStart(String paramString1, String paramString2) {
    ...
    try {
      localResultSet = localSDatabase1.executeQuery(str1);
      while (localResultSet.next()) {
        if (this.outStr.equals("")) this.outStr = getbyte(localResultSet.getString("MModuleNo")); else
          this.outStr = (this.outStr + "," + getbyte(localResultSet.getString("MModuleNo")));
      }
      localResultSet.close();
    } catch (Exception localException) {
      System.out.print(localException.getMessage());
  ...
  public String doleftmenuOutLookStart(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {
    SDatabase localSDatabase1 = new SDatabase();
    SDatabase localSDatabase2 = new SDatabase();
    regcheck localregcheck = new regcheck();
    localregcheck.checkREGIN();
    ...
    Object localObject2 = "";
    String str2 = "";
    str2 = "select Url,MModuleNo,CModuleNo,CModuleName,picpath,nexus,title  from ModuleCortrol where    MModuleNo='" + paramString1 + "' and CModuleNo in(select ModuleNo from  PopedomConrtrol where SellerId='" + paramString6 + "') ORDER BY orderby";
    if (paramString1.equals("DESKTOP")) {
      str2 = "select Url,MModuleNo,CModuleNo,CModuleName,picpath,nexus,title  from ModuleCortrol where     MModuleNo='" + paramString1 + "' or  ( CModuleNo in(select ModuleNo from  PopedomConrtrol where SellerId='" + paramString6 + "'  and choose=1)) ORDER BY orderby";
    }
    ResultSet localResultSet = null;
    try {
      ...
      while (localResultSet.next()) {
        ...
        String str6 = getbyte(localResultSet.getString("CModuleName")).trim();
        ...
        localObject2 = str4;
        if (str8.equals("P")) { localObject1 = str6;
        } else {
          str1 = str1 + "\"" + str7 + "\",";
      ...
      if (!str1.equals("")) {
        ...
        str1 = " OutBarFolder" + paramString2 + "=new Array(\"" + paramString3 + "," + paramString5 + "&MModuleNo=" + (String)localObject2 + "\"," + str1 + ");";
      }
      localResultSet.close();
    }
    catch (Exception localException) {
  ...
  public String DoTopMenu(String paramString1, String paramString2) {
    ...
    String str4 = "";
    try {
      ResultSet localResultSet = localSDatabase.executeQuery("select servicephone,serviceperson,saleurl,saleperson from  user_reg");
      if (localResultSet.next())
      {
        str1 = localResultSet.getString("servicephone");
        str2 = localResultSet.getString("serviceperson");
    ...
    if (localregcheck.state == 1) this.outStr = (this.outStr + "软件提供商：U客软件　          　正式注册编码：hcrm-" + localregcheck.userregno);
    this.outStr += "'>";
    ...
    this.outStr = (this.outStr + " <img src='../images/set.gif' width='15' height='15' hspace='8' align='absmiddle'><span class='style3' onclick=\"openwin1('../sys/chane_set.jsp',300,500,100,100);\"  title='设置我的快捷菜单' onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'><font color=#000000>快捷菜单</font></span><img src='../images/phone.gif' width='23' height='16' hspace='8' align='absmiddle'><span class='style4'  onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'  title='技术支持联系人:" + str2 + ",电话:" + str1 + "'><font color=#000000>服务</font></span><img src='../images/home.gif' width='15' height='15' hspace='5' align='absmiddle'><span class='style2' onMouseOver='OverArrow(this)'  title='" + str4 + "' onclick=\"window.open('http://" + str3 + "');return false;\" onMouseOut='OutArrow(this)' style='cursor:hand;'      target=rightp><font color=#000000>主页</font></span><img src='images/user.gif' width='15' height='15' hspace='8' align='absmiddle'><span class='style4' onclick=\"openwin1('../sys/chane_reg.jsp',300,200,100,100);\" onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;' title='修改登录用户'><font color=#000000>帐号</font></span><img src='../images/icon_edit_topic.gif' width='15' height=15 hspace=8 align='absmiddle' ><span class='style3' onclick=\"openwin1('../sys/ChangePassword.jsp',300,200,100,100);\" onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'  title='修改登录密码'><font color=#000000>密码</font></span><img src='../images/standard_basic.gif' width='15' height='15' hspace='5' align='absmiddle'>");
    ...
    if (localregcheck.state == 0) this.outStr += " <font color=#000000>注册</font>"; else this.outStr += " <font color=#000000>关于</font>";
  ...
  public String doStartTag(String paramString)
  {
    ...
    String str4 = "";
    try {
      ResultSet localResultSet1 = localSDatabase.executeQuery("select servicephone,serviceperson,saleurl,saleperson from  user_reg");
      ...
      localResultSet1.close(); } catch (Exception localException1) {
    ...
    this.outStr = (this.outStr + " <img src='images/set.gif' width='15' height='15' hspace='8' align='absmiddle'><span class='style4' onclick=\"openwin1('../sys/chane_set.jsp',500,500,100,100);\" onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;' title='修改我的桌面内容'>桌面设置</span><img src='images/user.gif' width='15' height='15' hspace='8' align='absmiddle'><span class='style4' onclick=\"openwin1('../sys/chane_reg.jsp',300,200,100,100);\"  title='修改登录用户' onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'>修改帐号</span><img src='images/set.gif' width='15' height='15' hspace='8' align='absmiddle'><span class='style4' onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;' onclick=\"window.parent.contents.location='../manager/menu.jsp?MModuleNo=M';window.parent.main.location='../manager/log.jsp';\" title='进入系统管理模块'>系统设置</span><img src='../images/phone.gif' width='23' height='16' hspace='8' align='absmiddle'><span class='style4'  onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'  title='技术支持联系人:" + str2 + ",电话:" + str1 + "'>服务</span><img src='images/home.gif' width='15' height='15' hspace='5' align='absmiddle'><span class='style2' onMouseOver='OverArrow(this)' title='" + str4 + "' onclick=\"window.open('http://" + str3 + "');return false;\"  onMouseOut='OutArrow(this)' style='cursor:hand;'      target=rightp>主页</span><img src='../images/icon_edit_topic.gif' width='15' height=15 hspace=8 align='absmiddle' ><span class='style3' onclick=\"openwin1('../sys/ChangePassword.jsp',300,200,100,100);\"  title='修改登录密码' onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;' >密码</span><img src='../images/standard_basic.gif' width='15' height='15' hspace='5' align='absmiddle'>");
    this.outStr += " <span class='style2' onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'  onClick=\"reg();return false;\"   title='注册时请连接internet网络'  target=rightp>";
    if (localregcheck.state == 0) this.outStr += " 注册"; else this.outStr += " 关于";
    ...
    String str5 = "select Url,MModuleNo,CModuleNo,MModuleName,picpath,nexus,title  from ModuleCortrol where (MModuleNo<>'M' ) and nexus='P' and  MModuleNo in(select manModule from  ManModuleCortrol where SellerId='" + paramString + "') ORDER BY orderby  ";
    try {
      ...
      while (localResultSet2.next()) {
        ...
        str13 = "../" + str6;
        this.outStr = (this.outStr + "  <td valign='top' onclick=\"\"><img title=" + str12 + " onclick=\"window.parent.contents.location='../manager/menu.jsp?MModuleNo=" + str7 + "';window.parent.main.location='" + str13 + "';menupic(this);windowstate('" + str9 + "')\" onMouseOver='OverArrow(this)'  onMouseOut='OutArrow(this)' style='cursor:hand;'  src=" + str10 + " width='32' height='32'  border=0 ><br>" + str9 + "</td>");
      }
  ...
  public String doReadProject(String paramString) {
    ...
    if (paramString.indexOf("A") >= 0) this.outStr += "<input type=button name=add value='增 加' title='添加楼盘资料'  onclick=\"openwin2('crm_Project_add.jsp',650,580,100,10);\">";
    if (paramString.indexOf("E") >= 0) this.outStr += "<input type=button name=modi value=\"修 改\" title=\"修改选中的楼盘资料\" onclick=\"EditInto();\" >";
    if (paramString.indexOf("D") >= 0) this.outStr += "<input type=button name=del value=\"删　除\" title=\"删除选中的楼盘资料\"  onclick=\"Dele();\">";
    if (paramString.indexOf("F") >= 0) this.outStr += "<input type=button name=del value=\"房间明细表\"   onclick=\"openwin2('../sale/auto_select.jsp?PARA_SQL=ViewSectionData&url=22&reporttype=sale&tablename=',700,400,50,50);\">";
    ...
    if (str1.equals("0"))
      ...
      str2 = str2 + " top " + str1 + " * from CRM_Project order by code asc";
    String str3 = "";
    String str4 = "";
    String str5 = "";
    ...
    try {
      ...
      while (localResultSet.next()) {
        ...
        String str6 = localFormatData.getFloat(localResultSet.getFloat("TotalArea"), 4);
        String str7 = localFormatData.getFloat(localResultSet.getFloat("GroundArea"), 2);
        String str8 = localFormatData.getFloat(localResultSet.getFloat("GreenRate"), 3);
        ...
        if (!str10.equals("")) {
          ...
          str10 = localSimpleDateFormat.format(localSimpleDateFormat.parse(str10));
        }
        int j = localResultSet.getInt("FamilyCount");
        String str9 = localFormatData.getFloat(localResultSet.getFloat("RealRate"), 3);
        this.outStr = (this.outStr + "  <tr id=TR" + k + " align=\"center\"  ondblclick=\"openwin2('SectionShow.jsp?ID=" + str12 + "',480,420,100,10);\" class=listcontent onmouseover=\"mout(this);\"  onclick=\"savepara('" + str12 + "','" + str3 + "','" + str4 + "');changeclass1(this,'clickbg','listcontent');\"  title=\"双击可查看楼盘资料\" >");
        ...
        this.outStr = (this.outStr + " <td><input type=button value=\"楼 栋\" title=\"增加楼栋资料\" onclick=\"openwin2('indexTree.jsp?SecNo=" + str3 + "',450,300,100,100);\">&nbsp;<input type=button value=\"图片\" title=\"增加地图\" onclick=\"openwin2('AddPic.jsp?SecNo=" + str3 + "',450,300,100,100);\"></td>");
        this.outStr += "</tr>";
      }

      localResultSet.close(); } catch (Exception localException2) {
      System.out.print(localException2.getMessage());
    }
    return this.outStr;
  }
  public String doStartReg(String paramString1, String paramString2, String paramString3) {
    SDatabase localSDatabase = new SDatabase();
    ...
    ResultSet localResultSet = null;
    try {
      localResultSet = localSDatabase.executeQuery("select  top 1 CompanyName,regnum,usernum,project from company");
      if (localResultSet.next()) {
        ...
        if (str4.equals("0")) str4 = "无限";
        if (str3.equals("0")) str3 = "无限";
      }
      localResultSet.close(); } catch (Exception localException) {
      System.out.print(localException.getMessage());
    }this.outStr = "<table width='100%'  border='0' cellpadding='0' cellspacing='0'>";
    ...
    this.outStr = (this.outStr + " <td width='38%' height='16'>并发用户数：" + str4 + "&nbsp;许可楼盘数：" + str3 + "</td>");
    ...
    this.outStr = (this.outStr + "<td width='38%' height='14'><input type=text name=endd size='42' value='" + localSimpleDateFormat.format(new Date()).toString() + "'></td>");
    this.outStr += " </tr>";
    this.outStr += "<tr>";
    ...
    int i = 0;
    if (!str6.equals("")) { this.outStr = str6;
    } else if (!paramString2.equals("")) {
      String str7 = localregcheck.checkREGInfo(paramString2, paramString1, paramString3);
      if (!str7.equals("")) this.outStr = str7;
    }
  ...
  public String checkREG()
  {
    ...
    if (str4.equals("0")) {
      String str6 = "select  * from  user_reg  where  convert(char(10),'" + str3 + "',120) <convert(char(10),getdate(),120)  and convert(char(10),'" + str5 + "',120)<=convert(char(10),getdate(),120)  and state=0";
      try
      {
        ...
        if (localResultSet.next())
        {
          ...
          localResultSet.close();
          String str7 = "select  * from  user_reg where convert(char(10),'" + str5 + "',120)<=convert(char(10),getdate(),120) and state=" + str4;
  ...
  public String doStart(String paramString, int paramInt) {
    ...
    if (!paramString.equals(""))
    {
      ...
      writereadregedit localwritereadregedit = new writereadregedit();
      if (localwritereadregedit.writeinfo().equals("")) str2 = "";
      ...
      if (str2.indexOf("过期") >= 0) {
        ...
        if (localwritereadregedit.writeinfo().equals("")) str3 = "你可能第一次安装U客软件，请重新激活系统后才能正常使用";
