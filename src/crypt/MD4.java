...
public class MD4
{
    ...
    public String getMD4ofStr(String inbuf)
    {
        MD4Init();
        MD4Update(inbuf.getBytes(), inbuf.length());
        MD4Final();
        digestHexStr = "";
        for(int i = 0; i < 16; i++)
    ...
    private void MD4Update(byte abyte0[], int i)
    {
        ...
        if(i >= l)
        {
            MD4Memcpy(buffer, abyte0, k, 0, l);
            MD4Transform(buffer);
            for(j = l; j + 63 < i; j += 64)
            {
                MD4Memcpy(abyte1, abyte0, 0, j, 64);
                MD4Transform(abyte1);
            }
        ...
        MD4Memcpy(buffer, abyte0, k, j, i - j);
    }

    private void MD4Final()
    {
    ...
    private void MD4Memcpy(byte abyte0[], byte abyte1[], int i, int j, int k)
    {
        for(int l = 0; l < k; l++)
    ...
    private void MD4Transform(byte abyte0[])
    {
        long l = state[0];
        long l1 = state[1];
        long l2 = state[2];
    ...
    public static void main(String args[])
    {
        ...
        if(Array.getLength(args) == 0)
        {
            ...
            System.out.println("MD4(\"\"):" + MD4.getMD4ofStr(""));
            System.out.println("MD4(\"a\"):" + MD4.getMD4ofStr("a"));
            System.out.println("MD4(\"abc\"):" + MD4.getMD4ofStr("abc"));
            System.out.println("MD4(\"scsteven\"):" + MD4.getMD4ofStr("scsteven"));
            System.out.println("MD4(\"message digest\"):" + MD4.getMD4ofStr("message digest"));
            System.out.println("MD4(\"abcdefghijklmnopqrstuvwxyz\"):" + MD4.getMD4ofStr("abcdefghijklmnopqrstuvwxyz"));
            System.out.println("MD4(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):" + MD4.getMD4ofStr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
        } else
        {
            System.out.println("MD4(" + args[0] + ")=" + MD4.getMD4ofStr(args[0]));
        }
    }
