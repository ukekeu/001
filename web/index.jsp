...
<body topmargin="0" oncontextmenu="return false">
						...
						<tr>
							<td height="120" colspan="2">&nbsp;<%
								if (day > 0 && day < 6 && infoState.equals("0")) {
										out.print("<font color=red>可用时间为:" + day + "天</font>");
 ...
 %>
					...
					out.print("disabled");
									...
									<option value=2>样式3</option>
									<option value=3>样式4</option>
						...
						<tr>
							<td colspan="2"><table width="100%" border="0"
									...
									<tr>
										...
										<td><div align="right">
												<a href="#" OnClick="logincheck();" title="进入系统"><img
													src="images/dl.gif" width="81" height="22" border="0">
												</a>
											</div></td>
										<td width="30">&nbsp;</td>
										<td><a href="#" onclick="window.close();" title="关闭窗口"><img
												src="images/tc.gif" width="81" height="22" border="0">
										</a>
										</td>
										<td><a href="#"
											onclick="openwin('help.jsp',600,600,100,100);" title="登录帮助"><img
			...
			<tr>
				<td height="108" background="images/bottom_bg.gif" align="center">&nbsp;
					U客软件 版权所有<br> <a href="#"
					onclick="alert('技术服务电话：15814891599');" title="关闭窗口"> <img
