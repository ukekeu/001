...
<tr> 
    <td class="<%if(sel.equals("1")){out.print("menuselect3");}else{out.print("selemenu4");}%>" align="center" width=88 height=21>
	  <a href="#" onclick="document.form1.sel.value=1;findSub('ld_customer_alert.jsp');"> <font color='<%if(sel.equals("1")){out.print("#FFFFFF");}else{out.print("#000000");}%>'>跟进提醒 
	</td>
   <td class="<%if(sel.equals("2")){out.print("menuselect3");}else{out.print("selemenu4");}%>" align="center" width=88 height=21>
	  <a href="#" onclick="document.form1.sel.value=2;findSub('visitcusview1.jsp');"> <font color='<%if(sel.equals("2")){out.print("#FFFFFF");}else{out.print("#000000");}%>'>临定一览 
	</td>
	</tr>
</table>
...
<table width="100%"  border=1 cellspacing='0'  cellpadding='0' bgcolor=ffffff bordercolordark=ffffff bordercolorlight=000000>
  ...
  <td  align="center">临定日期</td>
  <td  align="center">失效日期</td>
  <td  align="center">临定单位</td>
...
　
 <%	
  ...
  sql="select b.*,convert(char(10),a.date,120) gzdate,convert(char(10),c.startdate,120) rgdate,convert(char(10),c.enddate,120) enddate, a.num,d.loft+d.room_code roomno  from tail_after a,customer b,SL_TemporarilyBuy c,room d where  c.roomcode=d.code and  b.serialno=c.cusname and c.state=0 and a.state=0 and a.cusno=b.serialno and cusno in (select cusno from      tail_after group by  cusno  ) and dateadd(dd,alert_day,a.date)<getdate() "+lffs +" and b.Section in("+SectionS+")   "+strWhere;
  ...
  int tr=0;
   while (rs.next()){
	 ...
	 String gz_date=getbyte(rs.getString("gzdate"));
	  String enddate=getbyte(rs.getString("enddate"));
	   if (!enddate.equals(""))enddate=enddate.substring(0,10);
 ...
 <td align="center"><%=region %>&nbsp;</td>
    <td  align="center"><a href="#" onclick="openwin('editcustomerok.jsp?cusno=<%=no %>',560,560,100,5);" title="点击可以弹出窗口修改资料"><%=name %></a>　&nbsp;</td>
     <td  align="center">
	<%String strt="";
	String strs=""; 
