...
<input type=hidden name=condi>
 ...
 <p align=center class=FontColor><font size=3><b 临定客户一览表</b></font></p> 
...
out.print("<p align=center class=FontColor><font size=3><b>临定客户 一览表</b></font></p>");
%>
...
<%} %>
   ...
   <option value=visit_date>临定日期</option>
   <input type=text name=search_like size=30 title="模糊查询，可查询姓名、电话、地址，双击可弹出日期" ondblclick="fPopUpCalendarDlg(search_like);return false;" value="<%=search_like %>"><input type=button name=fin value="查 询"  onclick="document.form1.submit();" >&nbsp;<%if (Cortrol.indexOf("F")>=0){ %><input type=button name=outdata value="导入EXCEL" onclick="outexcel();"><%} %></td>  </tr></table>
