...
<TABLE   border=0 cellPadding=0 cellSpacing=0 width=118%   align="top" height="100%"> 
  <TR align="top" align=left>
	...
	<%@ include file="../public_js/CheckPopedom.jsp"%>
	  ...
	  String SqlStr="select Url,CModuleNo,CModuleName  from ModuleCortrol where MModuleNo='C' and CModuleNo in(select ModuleNo from PopedomConrtrol where SellerId='"+userid+"') and nexus='C' order by CModuleNo";
	  ResultSet rs=null;
	  int i=1;
	  try{
