...
<td  align="left" title="<%=address %>"> &nbsp;<%
	...
	<td  align="center"><%=sell%>&nbsp;</td>
	 <td  align="center"><a href="#"  onclick="savepara('<%=no%>');changeclass1(this,'clickbg','listcontent');Edit('<%=no%>');"><%if (gzState){ %><font color=red>记录</font><%}else{ %>记录<%} %></td>
