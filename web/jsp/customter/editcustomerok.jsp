...
<% for (int ii=0;ii<300;ii++){
  ...
  <tr > <td width="15%" class=roomleft    height="24">&nbsp;客户姓名</td><td  colspan=3  class=roomright width="15%"     height="24"> &nbsp;<input type=text     name=name size="18"  value="<%=name %>" readonly onkeydown="key(document.cus.sex)"  ><font color=red>*</font>等级<select size="1"    name="grade"  >   
<option></option> 
    <%
   for (int ii=0;ii<300;ii++){
		  if (CodeType[ii]!=null){
...
<tr   > 
<td width="15%"   class=roomleft  height="24">&nbsp;单　位</td><td class=roomright width="15%"  colspan=3   height="24">&nbsp;<input type=text     name=company size="56"  value="<%=company %>" onkeydown="key(document.cus.addr)"  >  </td>
</tr> 

<tr>
<td width="15%" class=roomleft    height="23">&nbsp;联系地址</td><td class=roomright width="15%"     height="23" colspan=3> 
 &nbsp;<input type=text     name=addr size="56" value="<%=addr %>" onkeydown="key(document.cus.Date1)" > </td>
</td>
</tr>
...
<tr   >
 ...
 &nbsp;<select size="1" name="seller" onkeydown="key(document.cus.demand)"  >
    <option value=""></option>
...
<tr> 
 ...
 <table BORDER=0 width="100%"  CELLSPACING=1 CELLPADDING=3 ALIGN=center>
  ...
  <%
  String SQL="select * from CustomerDc where TYPE=1 AND  sectionno='"+section+"'";
