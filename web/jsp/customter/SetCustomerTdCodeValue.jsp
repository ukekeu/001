...
String SQL="";
   String code="";
   if (codes!=null){
   ViewBean.executeUpdate("delete CustomerTdCodeValue where  customer='"+customer+"'");
   for (int i=0;i<codes.length;i++){
      SQL="insert into CustomerTdCodeValue(codevalue,customer) values("+codes[i]+",'"+customer+"')";
...
int arrInt=0;
ResultSet rs=null;
SQL="SELECT COUNT(*) NUM FROM CustomerTdCodeValue where customer='"+customer+"'";
 ...
 SQL="SELECT codevalue FROM CustomerTdCodeValue where customer='"+customer+"'";
 rs=ViewBean.executeQuery(SQL);	
 int j=0;
 while (rs.next()){
