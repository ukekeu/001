...
String sq =  " select a.dengji_riqi,a.shixiao_riqi,a.vipno,a.yscyj , a.yxdw1,a.room,b.*,a.context,a.send outstate "
...
String Room1="",customerno="",vipno="",cyj="5000",bak="",csdate="";
...
if( rs.next() ) {
    ...
    in8 = getbyte( rs.getString( "Zip_Code" ) ) ;
     ...
     in16=getbyte(rs.getString("seller")).trim();
 ...
 Room1= getbyte( rs.getString( "yxdw1" ) ) ;
	...
	bak= getbyte( rs.getString( "context" ) ) ;
	if (rs.getInt( "outstate")==0)outstate="checked";
...
String building1="";
String room1="";
String sq2 = " select * from tb_chengyi_danwei where serialNo "
            + " ='" + ref_id + "' " ;
int k=0;
ResultSet rsy = null;
...
function full(){
	  ...
	  setSelectMad(document.cus.Region,'<%=region%>');
	    ...
	    setSelectMad2(document.cus.seller,'<%=in16%>');   
...
<tr>
 ...
 <select style="width : 139" name="section" style="width:117"><option></option>
 <%
...
<input type=text    name=in2 size="6"  onkeydown="key(document.cus.name2)"  value="<%=in2 %>"  > <select style="width : 50"  name="sex1"  onkeydown="key(document.cus.sex2)"> 
...
<input type=text     name=csdate size="14"  value="<%=csdate %>"    ><input type=button name=cale value=".." onclick="fPopUpCalendarDlg(csdate);return false">
    ...
    <tr>
      ...
      <td width="25%" class=roomright ><input type=text name=in6 size=18 value="<%= in6 %>"></td>
    </tr>
	<tr align="left" > 
	 
<td width="25%" align="left"class=roomleft  height="24">&nbsp;单&nbsp;&nbsp;&nbsp;&nbsp;位</td>
<td class=roomright width="25%" align="left"   height="24"><input type=text    name=company size="18" value="<%=company %>"> 
</td>
<td width="25%"class=roomleft  align="left" height="23"> &nbsp;邮&nbsp;&nbsp;&nbsp;&nbsp;编</td><td class=roomright width="25%"   align="left" height="23">
 <input type=text    name=in8 size="18" value="<%=in8 %>"></td>
</tr> 
 ...
 <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="25%" class=roomright  colspan="3">1.<input type=text name=in17 value="<%= Room %>"size=18 >&nbsp;2.<input type=text name=in17a  value="<%=Room1 %>" size=18 >
         
      </td>
    </tr>
    <tr> 
      <td width="25%" align="left" class=roomleft >&nbsp;登记日期</td>
      <td width="25%" class=roomright ><input type=text name=in13 size=13 value="<%= in13 %>" readonly><input type=button name=cale value=".." onclick="fPopUpCalendarDlg(in13);return false;" ><font color=red>*</font></td>
...
<tr> 
          <td width="130" height="23" background="../images/head_7.gif">　<img src="../images/day2.gif" width="18" height="13" vspace="2" align="absmiddle"><strong>调查反馈</strong></td>
