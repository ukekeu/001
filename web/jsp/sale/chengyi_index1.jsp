...
String Cortrol=checke_qx(ViewBean,(String)session.getAttribute("loginid"),"QT11");
    ...
    %>
	<td><input name="choos" type="radio" value=2 <%if (choos.equals("2"))out.print("checked"); %> onclick="zh();">全部&nbsp;<input name="choos" type="radio" value=1 <%if (choos.equals("1"))out.print("checked"); %> onclick="zh();">已收诚意金<input name="choos" type="radio" value=0 onclick="zh1();" <%if (choos.equals("0"))out.print("checked"); %>>未收诚意金
</td>
  ...
  <td ><%= context%></td>
					 ...
					 <!--
						<%if (Cortrol.indexOf("E")>=0){ %>
						  ...
						  <td > <img src="../images/icon_print.gif" alt='打印vip' onclick="openwin('PrintCusVIP.jsp?code=<%=REF_ID %>');" onmouseover="javascript:this.style.cursor='hand'"></td>
...
document.form1.submit();
  ...
  function outexcel(){
    if (document.form1.section.value==""){alert("请选择项目");return false;}
	  window.open("chengyi_djlist.jsp?section="+document.form1.section.value+"&stateshow="+document.form1.stateshow.value)
