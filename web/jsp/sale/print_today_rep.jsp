...
<br>	   <form name=frm method="post" action="SaleToday.jsp"  target="_blank">
	    <table width="80%" cellspacing="1" cellpadding>
                    ...
                    <tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center"><font size="2" color="#000080">日期：</font></td>
					  <input type="hidden" onkeydown="key(document.cus.VisaDate)" title="请选择日期" size="11" name="Date1">
					  <td width="50%" bgcolor="#EAEAEA" align="center"><input onkeydown="key(document.cus.VisaDate)" title="请选择日期" size="11" name="Date2"><input title="" onclick="fPopUpCalendarDlg(Date2);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
