...
<br>
	   <form name=frm method="post" action="salecountreopt.jsp"  target="_blank">
      ...
      String sql="select SerialNo,Name from CRM_Project "+FindWhere;
					   ResultSet rs2=ViewBean.executeQuery(sql);
	                    String sec="";
	                    String no=""; %>
<select name="SecNo"  onclick="changebuild(this);" style="width=100;">
					      <option value=""></option>
						  <%while (rs2.next()){
					...
					<tr>
					 ...
					 <select name="Loft"  style="width=100;">
					      <option value=""></option>
