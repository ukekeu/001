...
<br>
	   <form name=frm method="post" action="printmx.jsp"  target="_blank">
	    <table width="30%" cellspacing="1" cellpadding>
                    <tr>
                      <td  align="center"><font size="2" color="#000080">开始日期：</font></td>
                    ...
                    <tr>
                      <td  align="center"><font size="2" color="#000080">结束日期：</font></td>
                    ...
                    <tr>
                      <td   align="center"><font size="2" color="#000080">选择楼盘:&nbsp;</font></td>
					  <td   align="center">
