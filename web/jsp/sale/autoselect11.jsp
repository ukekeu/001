...
if (document.forms[0].Date2.value.length<1){
 ...
 if (document.forms[0].LD.value=="1")document.forms[0].action="printLdReport.jsp";
 else document.forms[0].action="printsxLdReport.jsp";
}
...
<br>
	   <form name=frm method="post" action="printLdReport.jsp" target="_blank">
...
<select name="SecNo"  onclick="" style="width=110;" ><!--changebuild(this);-->
					 ...
					 <tr>
                      <td  align="center"><font   color="#000080">临定状态:&nbsp;</font></td>
					  <td  align="center" >
					 <select name="LD"  style="width=110;">
