...
<form method="post" name="frm">
  ...
  <table width=100% border="0"><tr    ><td align="left">楼盘：<select name="section" onchange="document.frm.submit();"> 
   <option></option>
<%  
...
<center><font size=4><b><%=sectionname %>项目营销费用支出与销售情况统计表</b></font></center>
<br>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="AutoNumber1">
  ...
  <tr align="center">
  <%if (j==0){ %>
    <td width="2%" rowspan="<%=rows%>">计<br>划<br>指<br>标</td>
	<%}j++; %>
  ...
  <%if (j==0){ %>
    <td width="2%" rowspan="<%=rows*2%>">实<br>际<br>支<br>出</td>
	<%}j++; %>
 ...
 <tr align="center"><td colspan="3"><b>合计金额：</b></td>
  ...
  <%  list1.clear();
   ...
   %>
  <tr align="center">
     <td width="2%" rowspan="3">销<br>售<br>面<br>积</td>
  ...
  <tr align="center" style="background-color:#F7F7F7">
    ...
    <td width="3%" rowspan="3">销<br>售<br>套<br>数</td>
  ...
  <tr align="center">
    ...
    <td width="2%" rowspan="3">销<br>售<br>金<br>额</td>
  ...
  <tr align="center" style="background-color:#F7F7F7">
    ...
    <td width="2%" rowspan="3">回<br>款<br>情<br>况</td>
