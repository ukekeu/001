...
if (cusname.equals("")){//如果此客户没有在客户资料中登录，现增加此客户
		  ...
		  sql1+="ID_Card, Address,Zip_Code,visit_date, seller,bbj,sj)";
		  sql1+=" values('"+secno+"','"+cusno+"','"+Cus_Name+"','"+Cus_Name+"','"+Phone+"','";
		  sql1+=ID_Card+"','"+Address+"','"+Zip_Code+"',convert(char(24),getdate(),111),'"+person+"','"+bbj+"','"+sj+"')";
		  }
