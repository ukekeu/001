	...
	if (!SecNo.equals(""))SectionS="'"+SectionS+"'";
	  ...
	  while (rs2.next()){
	   ...
	   sec=getbyte(rs2.getString("Name"));
	    ...
	    rs2.close();
  %>  <td><input type=button name="EXCELTO" value="导出到EXCEL" onclick="bringToExcel()"></td>
	 </tr>
</table>
  <div align=left id=report1 style="background-color:#F7F7F7;height:100%;overflow:auto;width:100%;z-index:2" contentEditable >

<table border="0" ><tr>
<%String manSQL="select Loft FROM sectiontree where SerialNo='"+strSection+"' and loft in ("+Loft+") group by Loft";
...
<p CLASS=FontColor><b><font size="3" ><%if (!SecName.equals(Loft)){out.print(SecName);} %><%=Loft+strBuilding %>销控表</font></b></p>
 <table width="100%" border="1" CELLSPACING=0 CELLPADDING=0  bgcolor=ffffff bordercolordark=ffffff bordercolorlight=000000>
    <tr>
		<td bgcolor='<%=ws1 %>' align="center">未售</td>
	 ...
	 <tr>
		<td bgcolor='<%=ws1 %>' align="center"><div id=wy<%=aaa %>></div></td>
	    ...
	    <td   align="center"><div id=sum<%=aaa %>> </div></td>
	
	</tr>
	<tr>
		<td bgcolor='<%=ws1 %>' align="center"><div id=w1<%=aaa %>></div></td>
...
String sqlArr="select   a.Room_code,a.saleState,a.Floor,a.Room,a.area,a.sumprice,a.floorshow,a.floortype,a.floormess,b.showfloors from roomstateview a,roomno b where a.seccode+a.loft+a.room_code= b.SectionNo+b.region+b.roomno and a.seccode=";
		...
		int arrlen=0;
	 %>
	 <td align="center"><%if (!Rinfo.equals("")) {out.print(Rinfo+"单元");}%>
	 <table border="1" CELLSPACING=0 CELLPADDING=0 bgcolor=ffffff bordercolordark=ffffff bordercolorlight=000000>
	   <tr> 
		 		<%
