...
<p align="center"> <div   id="divprint" align="center"><input type="button" name="Button" value="打印预览"  title="打印前请先收起左边楼栋树" onClick="openwin('print_sale_view_charges.jsp?section=<%=section %>&yearmonth=<%=CurYear %>');"> <input type="button" onclick="bringToExcel()" value="导出到Excel"><br>
