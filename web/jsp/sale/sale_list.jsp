...
<div align=left id=report1 >
 ...
 <table width="130%"><tr><td colspan="3">时间段:<%=China.getParameter(request,"Date1")%>到<%=China.getParameter(request,"Date2") %></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
...
rs.close(); 
 room=getbyte1(request.getParameter("room"));
  ...
  int sumnum=0;
   ...
   %>
   <tr>
   <td>小计</td><%if (getbyte1(request.getParameter("saletype")).equals("0")){ %><td>&nbsp;</td><%} %><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><%=payment%></td>
...
<%if (!getbyte1(request.getParameter("saletype")).equals("1")){ %><td>&nbsp;</td>     <td>&nbsp;</td>    <%} %>
  ...
  <%}%>
    <tr>
   <td>总计</td><%if (getbyte1(request.getParameter("saletype")).equals("0")){ %><td>&nbsp;</td><%} %><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><b><%=sumnum %></b></td>
