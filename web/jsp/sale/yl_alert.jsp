...
<p align=center class=FontColor><font size=3><b>预留到期一览表</b></p>
...
<table width="100%"  border=1 cellspacing='0'  cellpadding='0' bgcolor=ffffff bordercolordark=ffffff bordercolorlight=000000>
  ...
  <td  width="6%"  align="center">序号</td>
   <td  align="center">预留房间</td>
  <td  align="center">预留日期</td>
 
  <td  align="center">到期日期</td>
  <td  align="center">预留客户</td>
...
<a href="#" <%if (Cortrol.indexOf("Y")>=0){ %> onclick="document.form1.code.value='<%=code %>';document.form1.submit();" <%}else{out.print("titile='无权'");} %>>取消</a>
</td>
</tr>
<%ii++;}
rs.close(); 
