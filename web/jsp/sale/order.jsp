...
<tr> 
	...
	if (cusSerial.equals("null"))	cusSerial ="";
      ...
      <td class=roomright colspan="5">&nbsp;<input type=text   name="cusname1"  size=67  onkeydown="key(document.cus.carid)" title="如果多个姓名，请用'/'分隔" value="<%= cusName%>" onchange="aa();" ><input type=hidden name="editnow" value="2">
<input type=hidden name="cusname2" value="<%=cusName %>"><font color=red>*</font> <input type=button name=FindB  value="查找" onclick="FindOption();"> 
  ...
  function aa(){
    ...
    <tr> 
      ...
      <td class=roomright colspan="5">&nbsp;<input type=text  name="carid" title="如果多个，请用'/'分隔"   size=67   onblur="countAge();" onkeydown="key(document.cus.tel)" value="<%= cusID%>" >
        　</td>
   ...
   <option value=1>需要入户</option>
	...
	<tr> 
      ...
      <td class=roomright colspan="5">&nbsp;<input type=checkbox name=memberT value=1  onKeyDown="key(document.cus.youhui)"  ><input type=text name=memberNO  readonly   size=43 maxlength="50">&nbsp;<input type=button name=FindC  value="查找业主" onclick="FindOption1();"> 
	  </td>
	  </tr>
    <tr> 
   ...
   %>
    ...
    <tr> 
      ...
      <td  class=roomright  colspan="5">&nbsp;<textarea rows="3" onKeyDown="key(document.cus.listlar)" name="note" cols="35"  ></textarea> &nbsp;销售员:&nbsp; <select name="seller"  multiple size=3  onblur="SelectedSeller();" style="width:100">
          <option ></option>
          <option ></option>
          <option ></option>
          <option ></option>
...
<tr> 
    ...
    <tr> 
      ...
      <td width="12%" class=roomright>&nbsp;<input type=text name="rgsno"   size="10"   onChange="toUpper(document.cus.rgsno)" onKeyDown="key(document.cus.cale1)" onBlur="checkedOrderNoExist();" title="只能是英文字母、数字及"-"组成"></td>
 ...
 -->
   ...
   %>
		...
		<td class=roomright>&nbsp;<input type=text name=gjj size=10 value=0 OnBlur="check(this);dkcount1();">(元)</td>
   ...
   <td class=roomleft>&nbsp;商业  贷款</td>
		<td class=roomright>&nbsp;<input type=text name=sydk size=10  value=0 OnBlur="check(this);dkcount2();">(元)</td>
    ...
    <tr> 
      ...
      <td width="19%"    class=roomright  >&nbsp;以定价为准:<input type=checkbox name=bz value=1 <%if (Cortrol.indexOf("C")<0){ %> title="无审核权" disabled <%} %> checked onclick="checkcount();"></td>&nbsp;<td class=roomright>&nbsp;<input type=text name="dicprice"  defaultValue=""  value=0  size="10"     onblur="check(this);ykj_count();"    <%if (Cortrol.indexOf("C")==-1){ %>   readonly<%} %> >元
	...
	<td width="19%" class=roomleft >&nbsp;合同计价方式</td>
	 ...
	 <!--
      ...
      <td width="19%" class=roomright >&nbsp;<input type=text name="wd_area_sumprice" size=8 readonly  value="<%=wdprice %>" > 元</td>  </tr>
	   ...
	   <tr><td  class=roomleft>&nbsp;签约提醒</td><td colspan="5" class=roomright>&nbsp;<input type="test" size=10 name="qydate"  ><input type=checkbox name=gddate value=1> 固定日期 </td>
	   </tr>
	   <script>
	   function countlutai(){
