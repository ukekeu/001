...
if (saletype.equals("1"))saletype=" and  convert(char(10),date,120)>='"+stdate+"' and convert(char(10),date,120)<='"+endate+"' and state=1 ";
   ...
   String sql=""; 
   sql="select    a.rmbprice-a.ajmoney firstmoney,a.*,b.cus_name,b.phone + b.sj phone,b.address from order_contract a,customer b where a.customer=b.serialno and a.state<>3   and a.section='"+SectionName+"' "+saletype;
    if (!Loft.equals(""))
	  sql+=" and loft='"+Loft+"' ";
	   if (!room.equals(""))
...
rs.close(); 
 room=getbyte1(request.getParameter("room"));
  ...
  int sumnum=0;
   ...
   %>
   <tr>
   <td>小计</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><%=payment%></td>
  ...
  <%}%>
    <tr>
   <td>总计</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><b><%=sumnum %></b></td>
