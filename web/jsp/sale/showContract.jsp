...
<tr> 
  ...
  <table BORDER=0 width="100%" CELLSPACING=0 CELLPADDING=0 ALIGN=center bordercolor="#ffffff" class="tablefill">
     ...
     <input type=hidden name="cusname2" value="<%=cusname %>">
      <td colspan="2" class=roomright>&nbsp;&nbsp;<input type=text disabled  name="cusname1"  size=40 onchange="aa();" value="<%=cusname %>"  onkeydown="key(document.cus.carid)" title="如果多个姓名，请用'/'分隔">
       <!-- <font color=red>*</font> 
