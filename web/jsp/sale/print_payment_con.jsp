...
if (type.equals("1"))url="print_payment.jsp";
else if (type.equals("2"))url="print_cancel.jsp";
 %>
     <p align="center"><b><font size="3" color="#000080">请选择查询条件</font></b>
<br>
	   <form name=frm method="post" action="<%=url %>" target="_blank">
 
	    <table width="70%" cellspacing="1" cellpadding>
                    <tr>
                      <td  align="center"><font  color="#000080">开始日期：</font>
					  <input title="" size="11" name="Date1"><input title="" onclick="fPopUpCalendarDlg(Date1);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
                    <tr>
                      <td  align="center"><font  color="#000080">结束日期：</font>
					  <input  title="" size="11" name="Date2"><input title="" onclick="fPopUpCalendarDlg(Date2);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
...
<select name="SecNo"  onclick="" style="width=110;" ><!--changebuild(this);-->
					...
					<tr>
                      <td  align="center"><font   color="#000080">退房类型：</font> 
					 <select name="td"  style="width=110;">
					   <option value="">所有</option>
					   <option value="2">退房</option>
					      <option value="1">挞定</option>
