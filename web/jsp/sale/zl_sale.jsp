...
<input type="hidden" name="action" value=""> 
 <p align="center"><font size=3 class=FontColor><b>租赁登记</b></font></p>
 <center>
...
<tr> 
 <td  class=roomleft>&nbsp;管理费</td>
      <td  class=roomright   >&nbsp;<input type=text name="glf"  size=20 onKeyDown="key(document.cus.save)">元/月
  </td>
 <td  class=roomleft>&nbsp;租金</td>
      <td  class=roomright   >&nbsp;<input type=text name="zj"  size=20 onKeyDown="key(document.cus.save)">元/月
  </td>
</tr>	
<tr> 
 <td  class=roomleft>&nbsp;押金</td>
      <td  class=roomright   >&nbsp;<input type=text name="yj"  size=20 onKeyDown="key(document.cus.save)">元
  </td>
 <td  class=roomleft>&nbsp;经营方式</td>
      <td  class=roomright   >&nbsp;<select name="jytype"><option value=0>自营</option><option value=1>代营</option></select>
  </td>
</tr>	  
<tr> 
