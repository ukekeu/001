...
java.util.Enumeration e = mySmartUpload.getRequest().getParameterNames();
	...
	String []ht_codes=mySmartUpload.getRequest().getParameterValues("ht_code");
    String ht_code=ht_codes[0]; 
	
	 String   sql="";	 
    
     
		sql="update  zl_info set cusname='"+CUSNAME+"',Phone='"+phone+"', ";
		sql+="qd_date='"+Date2+"', startdate='"+Date1+"',enddate='"+Date3+"',zjn='"+cardid+"'";
		sql+=",zj="+zj+",yj="+yj+",htn='"+hth+"',linkman='"+linkman+"',bak='"+context+"'";
		if (!strPicture1.equals(""))
		sql+=",fileurl1='"+strPicture1+"'";
		if (!strPicture2.equals(""))
		sql+=",fileurl2='"+strPicture2+"'";
		sql+=",product='"+product+"' ";
		sql+=" where code="+ht_code;
	 try{
