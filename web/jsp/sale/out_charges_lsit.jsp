...
<input type=hidden name=section value="<%=request.getParameter("section")%>">
  ...
  <table width="99%" border="0" CELLSPACING=0 CELLPADDING=0 bordercolor="#000000" class="tablefill"> 
	...
	if (!section.equals("")&&!yeahmonth.equals("")){
	  String SQL="select b.code,a.charges_name,a.purpose,a.charges_value,b.fact_value,b.out_date,b.bak from out_charges a,fact_out_charges b  where a.code=b.out_charges and substring(convert(char(10),b.out_date,120),0,8)='"+month+"' and a.code="+codes;
