...
<form method="POST" name="cus" action="modi_knowledge_at1.jsp" onsubmit="return check(this);"  ENCTYPE="multipart/form-data">
<table width="100%" border="0" cellspacing="1"  cellpadding="1" >
 
  <%
   String  id=request.getParameter("id");
   String SQL="select type,title,text,adjunct from my_knowledge where id="+id;
   String my_id="";
   try{
    ResultSet rs=null;
   ViewBean.executeUpdate("update my_knowledge set see_num=see_num+1 where id="+id);
