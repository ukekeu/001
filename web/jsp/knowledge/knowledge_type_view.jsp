...
String sql="select  *  from knowledge_type  where typestate=0 ";
...
<%@ include file="../public_js/qx_checke.jsp"%>
 ...
 <%
//权限审核
String Cortrol=checke_qx(ViewBean1,(String)session.getAttribute("loginid"),"oa04");
out.print("<p align=center class=FontColor><font size=3><b>文档类别一览表</b></font></p>");
 %>
...
<script>
  ...
  function addCus(){
    openwin("knowlege_type.jsp?state=0&sel=0",500,300,100,5)
   }
