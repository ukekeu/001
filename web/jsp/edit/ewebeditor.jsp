...
var sLinkOriginalFileName = URLParams["originalfilename"] ;
var sLinkSaveFileName = URLParams["savefilename"] ;
var sLinkSavePathFileName = URLParams["savepathfilename"] ;
...
config.CusDir = (URLParams["cusdir"]) ? URLParams["cusdir"] : "";
