...
function TableInsert(){
	if (!isTableSelected()){
		showDialog('table.jsp', true);
	}
}

function TableProp(){
	if (isTableSelected()||isCursorInTableCell()){
		showDialog('table.jsp?action=modify', true);
	}
}

function TableCellProp(){
	if (isCursorInTableCell()){
		showDialog('tablecell.jsp', true);
	}
}

function TableCellSplit(){
	if (isCursorInTableCell()){
		showDialog('tablecellsplit.jsp',true);
	}
}

function TableRowProp(){
	if (isCursorInTableCell()){
		showDialog('tablecell.jsp?action=row', true);
	}
}
