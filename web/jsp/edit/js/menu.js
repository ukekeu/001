...
function showContextMenu(event){
	...
	if (isControlSelected("IMG")){
		sMenu += getMenuRow("", "showDialog('img.jsp', true)", "img.gif", lang["CMenuImg"]);
		sMenu += sMenuHr;
	...
	if (tagInSelection("P")){
		sMenu += getMenuRow("", "showDialog('paragraph.jsp', true)", "paragraph.gif", lang["CMenuParagraph"]);
		sMenu += sMenuHr;
		height += 22;
	}
...
function showToolMenu(menu){
	...
	case "font":
		...
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "showDialog('selcolor.jsp?action=forecolor', true)", "forecolor.gif", lang["ForeColor"]);
		sMenu += getMenuRow("", "showDialog('selcolor.jsp?action=backcolor', true)", "backcolor.gif", lang["BackColor"]);
		sMenu += sMenuHr;
	...
	case "paragraph":
		...
		sMenu += sMenuHr;
		sMenu += getMenuRow((tagInSelection("P")) ? "" : "disabled", "showDialog('paragraph.jsp', true)", "paragraph.gif", lang["CMenuParagraph"]);
		height = 226;
		break;
	case "edit":
		var s_Disabled = "";
		...
		break;
	case "object":
		sMenu += getMenuRow("", "showDialog('selcolor.jsp?action=bgcolor', true)", "bgcolor.gif", lang["BgColor"]);
		sMenu += getMenuRow("", "showDialog('backimage.jsp', true)", "bgpic.gif", lang["BackImage"]);
		sMenu += sMenuHr;
		...
		break;
	case "component":
		sMenu += getMenuRow("", "showDialog('img.jsp', true)", "img.gif", lang["Image"]);
		sMenu += getMenuRow("", "showDialog('flash.jsp', true)", "flash.gif", lang["Flash"]);
		sMenu += getMenuRow("", "showDialog('media.jsp', true)", "media.gif", lang["Media"]);
		sMenu += getMenuRow("", "showDialog('file.jsp', true)", "file.gif", lang["File"]);
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "remoteUpload()", "remoteupload.gif", lang["RemoteUpload"]);
		sMenu += getMenuRow("", "showDialog('localupload.jsp', true)", "localupload.gif", lang["LocalUpload"]);
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "showDialog('fieldset.jsp', true)", "fieldset.gif", lang["Fieldset"]);
		sMenu += getMenuRow("", "showDialog('iframe.jsp', true)", "iframe.gif", lang["Iframe"]);
		sMenu += getFormatMenuRow("InsertHorizontalRule", lang["HorizontalRule"], "inserthorizontalrule.gif");
		sMenu += getMenuRow("", "showDialog('marquee.jsp', true)", "marquee.gif", lang["Marquee"]);
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "createLink()", "createlink.gif", lang["CreateLink"]);
		sMenu += getMenuRow("", "showDialog('anchor.jsp', true)", "anchor.gif", lang["Anchor"]);
		sMenu += getMenuRow("", "mapEdit()", "map.gif", lang["Map"]);
		sMenu += getFormatMenuRow("UnLink", lang["Unlink"], "unlink.gif");
		height = 286;
		break;
	case "tool":
		sMenu += getMenuRow("", "showDialog('symbol.jsp', true)", "symbol.gif", lang["Symbol"]);
		sMenu += getMenuRow("", "insert('excel')", "excel.gif", lang["Excel"]);
		sMenu += getMenuRow("", "showDialog('emot.jsp', true)", "emot.gif", lang["Emot"]);
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "showDialog('eq.jsp', true)", "eq.gif", lang["EQ"]);
		sMenu += getMenuRow("", "showDialog('art.jsp', true)", "art.gif", lang["Art"]);
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "insert('nowdate')", "date.gif", lang["NowDate"]);
		sMenu += getMenuRow("", "insert('nowtime')", "time.gif", lang["NowTime"]);
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "showDialog('importword.jsp', true)", "importword.gif", lang["ImportWord"]);
		sMenu += getMenuRow("", "showDialog('importexcel.jsp', true)", "importexcel.gif", lang["ImportExcel"]);
		height = 186;
		break;
	case "file":
		...
		sMenu += sMenuHr;
		sMenu += getMenuRow("", "showDialog('about.jsp')", "about.gif", lang["About"]);
	...
	case "form":
		...
		break;
	case "gallery":
		sMenu += getMenuRow("", "showDialog('browse.jsp?type=image')", "galleryimage.gif", lang["GalleryImage"]);
		sMenu += getMenuRow("", "showDialog('browse.jsp?type=flash')", "galleryflash.gif", lang["GalleryFlash"]);
		sMenu += getMenuRow("", "showDialog('browse.jsp?type=media')", "gallerymedia.gif", lang["GalleryMedia"]);
		sMenu += getMenuRow("", "showDialog('browse.jsp?type=file')", "galleryfile.gif", lang["GalleryFile"]);
		height = 80;
		break;
	case "zoom":
