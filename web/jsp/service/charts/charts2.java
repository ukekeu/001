 ...
 //存放数据的数组
  ...
  public void paint(Graphics g)
  {
	 ...
	 {    
		...
		g.drawString(ytask_name,(yendX+1)*rowwidth+rowwidth/2,k*rowheight+rowheight/2);
		   ...
		   for(i=0;i<yafter_task_no.length;i++)
		   {
			  ...
			  {  
			        ...
			        if(after[1]-yendX>=1)
				 {
				    ...
				    {
                       y1=(after[0]+2)*rowheight-taskheight/2;
                       if(yexist_sub_task==0)
					   {  
				    ...
				    {
                       y1=(after[0]+2)*rowheight+taskheight/2+5;
                       if(yexist_sub_task==0)
					   {
			     ...
			     }else
				 {
			        ...
			        //画第三条横线
		            if(after[3]==1){
			           x2=after[1]*rowwidth-rowwidth/2-3*rowwidth/4;
			        }else
				    {  
                       x2=(after[1]-2)*rowwidth-rowwidth/2;
			        }
			        y1=y2;
			        g.drawLine(x1,y1,x2,y2);
					...
					if(after[3]==1)
					 ...
					 if(yexist_sub_task==0)
					 {
						 g.drawImage(img12,x1,y1,null);
					 }else
					 {
						 g.drawImage(img10,x1,y1,null);
					 }
				 }  
		      }  
			  ...
			  {  //如果是FF类型
			     if(after[2]-yendX>=0)
			     {
					...
					if(yexist_sub_task==0)
					 {
						 g.drawImage(img11,x1,y1,null);
					 }else
					 {
						 g.drawImage(img9,x1,y1,null);
					 }
