...
public class rectangle extends Applet {
  ...
  { 
	...
	if(ylen>0){
		...
		for(i=0;i<ydate.length;i++){
		   ...
		   pre=ydate[i]*100/sum;
		   g.setColor(Color.red);
		   g.drawString(df.format(ydate[i])+mess,inix+i*xbetween+20,(int)(ylen+iniy-y+10));
 ...
 public void setParameter(String X,String Y,String xdate,String ydate,String ylen,String xbetween,String mess){
