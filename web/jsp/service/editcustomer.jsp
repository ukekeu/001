...
<td width="25%" class=roomright align="left"   height="24">&nbsp;<input type=text size=5  value="<%=yy %>"   name=yy size="18"  maxlength=4 > 年<input type=text size=5  value="<%=mm %>"   maxlength=2 name=mm size="18"  >月<input type=text maxlength=2 size=5 value="<%=dd %>"     name=dd size="18"  >日
...
<tr align="left" > 
<td width="25%" align="left"class=roomleft  height="24" > &nbsp;单&nbsp;&nbsp;&nbsp;&nbsp;位</td><td class=roomright width="50%" align="left"   height="24" colspan="3">&nbsp;<input type=text    name=company size="30" onkeydown="key(document.cus.mail)"  value="<%=company %>"> 
 ...
 <option value="2001~3000">2001~3000</option>
  ...
  <option value="5001~8000">5001~8000</option>
   <option value="8001~12000">8001~12000</option>
    <option value="20001~更多">20001~更多</option>
 </td></tr>
...
<td class=roomright width="25%" align="left"   height="14"> 
 &nbsp;<input type=text    name=ho_tel size="18" title="多个电话号码间用/分隔" value="<%=ho_tel %>" onkeydown="key(document.cus.sj)"  >
</td>
</tr>
<tr align="left" > 
...
<td class=roomright width="25%" align="left"   height="14"> 
 &nbsp;<input type=text    name=of_tel size="18" title="多个电话号码间用/分隔" value="<%=of_tel %>" onkeydown="key(document.cus.sj)"  >
</td>
</tr>
<tr align="left" > 
...
<tr align="left" > 
<td width="25%"class=roomleft  align="left" height="23"> &nbsp;邮&nbsp;&nbsp;&nbsp;&nbsp;编</td><td class=roomright width="25%"   align="left" height="23"> &nbsp;<input type=text    name=pos size="18" onkeydown="key(document.cus.addr)" value="<%=zipcode %>"></td>
</tr> 
