...
++i;
    <%}userRs.close();%>
html="<select name='Loft' style='width=108;'><option value=''></option>"+arr.join();
html=html+"</select>";
...
<%if (!type.equals("2")&&!type.equals("3")&&!type.equals("9")&&!type.equals("12")){ %>		
...
<br>
	  ...
	  <input type=hidden name="type" value="<%=type %>">
	    <table  cellspacing="1" cellpadding>
                    <tr>
					  ...
					  <td width="50%" bgcolor="#EAEAEA" align="center"><input onkeydown="key(document.cus.Date1)" title="请选择认购日期" size="10" name="Date1"><input title="请选择开始日期" onclick="fPopUpCalendarDlg(Date1);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
                    <tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center"><font   color="#000080">结束日期：</font></td>
					  <td width="50%" bgcolor="#EAEAEA" align="center"><input onkeydown="key(document.cus.Date2)" title="请选择认购日期" size="10" name="Date2"><input title="请选择开始日期" onclick="fPopUpCalendarDlg(Date2);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
      ...
      String sql="select SerialNo,Name from CRM_Project "+FindWhere;
					   ResultSet rs2=ViewBean.executeQuery(sql);
	                    String sec="";
	                    String no=""; %>
<select name="SecNo"  onclick="" style="width=108;" onchange="changebuild(this);demeTaxname();">
					      <option value=""></option>
						  <%while (rs2.next()){
					...
					<tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center"><font  color="#000080">选择栋号:&nbsp;</font></td>
					  <td width="50%" bgcolor="#EAEAEA" align="center" id="sub">
					 <select name="Loft"  style="width=108;">
					      <option value=""></option>
						 
							</select>
					</tr>
					<%if (!type.equals("10")&&!type.equals("13")&&!type.equals("5")&&!type.equals("0")&&!type.equals("14")&&!type.equals("11")){ %>
					<tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center"><font   color="#000080">房间号:&nbsp;</font></td>
					  <td width="50%" bgcolor="#EAEAEA" align="center"  ><input type=text size=14 name=room >
					 </td>
					 </tr>
					  <tr>
                      <td width="50%" bgcolor="#EAEAEA"  align="center"><font  color="#000080">代收项目:&nbsp;</font></td>
					  <td width="50%" bgcolor="#EAEAEA"  align="center">
				 
<select name="TaxName"   style="width=108;"  >
					      <option value=""></option>
