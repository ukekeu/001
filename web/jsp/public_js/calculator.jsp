                        ...
                        border=0>
                          ...
                          <TR>
                            <TD width="100%" height=38>
                              ...
                              &nbsp; <INPUT class=font style="FONT-SIZE: 10pt; FONT-FAMILY: 宋体" type=reset value=清除> &nbsp; <INPUT class=font style="FONT-SIZE: 10pt; FONT-FAMILY: 宋体" type=button value=确认 onclick="WriteTo(this.form);"> 
