...
<%
 ...
 while (rs.next()){
	...
	%>	
	<tr align="center">
	<td width=15%  rowspan="2">一次置业<%//= PayName%><br>按揭<%//=rs.getInt("Discont") %></td>
...
for (int arr=0;arr<I1;arr++) {
 //if (arr==0)out.print("<td   >70% </td>");
  ...
  Double ajkmoney= (Double.parseDouble(sumprice1[arr])*disc*Double.parseDouble(yh)/100*Double.parseDouble(hy)/100*ajcs);
