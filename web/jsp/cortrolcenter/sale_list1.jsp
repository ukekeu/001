...
<% 
   ...
   String sql=""; 
   sql="select    * from roomView where out=1";
...
<td  align="center">备  注</td>
   ...
   while (rs.next()){
	...
	// String lt_price=FormtD.getFloat(ltp*lta,3);
	 ...
	 String Direction=getbyte(rs.getString("Direction"));
...
rs.close(); 
   ...
   <td><b><%=num %></b>套</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
  ...
  <%}%>
   ...
   <td>&nbsp;</td><td align="right"><b><%=FormtD.getFloat2(suma,2) %></b>M<sup>2</sup></td><td>&nbsp;</td><td>&nbsp;</td>
