...
<HEAD>
<TITLE>设置购房要提交的资料清单</TITLE> <META HTTP-EQUIV="Content-Type" CONTENT="text/html; chamisRset=gb2312"> 
...
<%
	...
	if (!aaa.equals("")){
	   ...
	   for (int i=1;i<9;i++){
		 ...
		 if (!data.equals("")){
          SQL="insert into  zy_tj_data(sectionno,dataname,type) values('"+section+"','"+data+"',1)";
	 ...
	 if ( java.lang.Integer.parseInt(aaaa)>0){
	   for (int i=1;i<=java.lang.Integer.parseInt(aaaa);i++){
	     ...
	     String SQL="";
		 if (data.equals(""))
		   SQL="delete zy_tj_data where type=1 and code="+datacode;
		 else
		    SQL="update  zy_tj_data  set dataname='"+data+"' where type=1 and code="+datacode;  
		  aBean.executeUpdate(SQL) ;
...
<form method="post" name=frm action="add_zy_data.jsp" > 
<Input type=hidden name="section1" value="<%=section %>">
<Input type=hidden name="aaa" value="aa">
  <table width="298" border="0" cellspacing="0" cellpadding="0">
<tr> 
          <td width="130" height="23" background="../images/head_7.gif">　<img src="../images/day2.gif" width="16" height="13" vspace="2" align="absmiddle"><strong>增加资料</strong></td>
...
<hr>
 <table width="298" border="0" cellspacing="0" cellpadding="0">
<tr> 
          <td width="130" height="23" background="../images/head_7.gif">　<img src="../images/day2.gif" width="16" height="13" vspace="2" align="absmiddle"><strong>已增加资料</strong></td>
          <td align="right" valign="top" background="../images/head_dd1.gif"><font color="#FF6600"> &nbsp;</font></td>
</tr>
</table>	
  <table BORDER=0 width="100%" CELLSPACING=1 CELLPADDING=1 ALIGN=center >
   <%    SQL="SELECT * FROM  zy_tj_data WHERE type=1 and sectionno='"+section+"'";
