...
function cqm(){
  ...
  <p ALIGN="CENTER" class=FontColor><b><font size=3><%=secname+ loft%>已领理产权一览表</font></b></p>
<input type=button name=pp value="打印产权证明细表" onclick="cqm();">
   ...
   <tr align="center"  class=txtcolor> 
    ...
    <TD> 
     ...
     <TD> 
	  ...
	  <TD> 
      <DIV ALIGN="CENTER">领取日期</DIV>
    </TD>
	  <TD> 
      <DIV ALIGN="CENTER">领取人</DIV>
    </TD>
  </TR>
  <%
