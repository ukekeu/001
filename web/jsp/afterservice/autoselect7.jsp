...
<%if (!request.getParameter("type").equals("10")&&!request.getParameter("type").equals("8")&&!request.getParameter("type").equals("9")&&!request.getParameter("type").equals("7")&&!request.getParameter("type").equals("6")){ %>		
...
else if (type.equals("8")) url="YhZjb.jsp";
else if (type.equals("9")) url="printSjb.jsp";
else if (type.equals("10")) url="CdList.jsp";
...
<select name="SecNo"  onclick="" style="width=108;" onchange="changebuild(this);"   ><!---->-->
					...
					<tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center"><font  size="2" color="#000080">按揭银行:&nbsp;</font></td>
					  <td width="50%" bgcolor="#EAEAEA" align="center">
					 <select name=ajbk  style="width : 105">
         <option></option>
		      <%
   ...
   %>
				  <%
		   while (rs2.next()){
			 out.print("<option value='"+getbyte(rs2.getString("codename"))+"'>"+getbyte(rs2.getString("codename"))+"</option>");
		   }
		   rs2.close();
				%> 
					</tr> 
					 ...
					 <tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center"><font  size="2" color="#000080">房　号:&nbsp;</font></td>
					  <td width="50%" bgcolor="#EAEAEA" align="center">
					  <input type=text name=room size=14>
					</tr> 
				</table>
				<input type=hidden name=secName>
				 <input type=button name=submit1 value="预 览/打 印" onclick="return checkdate(this);"> <input type=button name=winclose value="关 闭" onclick="window.close();" >
</form>     
