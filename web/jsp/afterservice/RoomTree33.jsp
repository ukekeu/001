...
<%
 ...
 %>
 <tr valign="middle">
 <td id="buil_<%=Loft%>"   onclick="changeclassname(this,'BL2','L2');"><img src="../images/document1.gif" border=0 align="absmiddle" hspace="4" >
<a href="#"  onclick="FindPro('<%=SectionSerialNo %>','<%=SectionName%>','<%=Loft %>','');aad2(s<%=num %>,250);"><%=Loft %></a><img src="../images/h.gif"  name="s<%=num %>"  value="<%=num %>" >
  </td><!---->
  </tr>
   <% 
...
<%//}%>
 <script language="JavaScript">
	...
	// parent.frmright.document.forms[0].sel.value="0";
if (parent.frmright.document.forms[0].action=="")
parent.frmright.document.forms[0].action="../afterservice/PropertyWBList.jsp";
parent.frmright.document.forms[0].submit();
	...
	if (parent.frmright.document.forms[0].action=="")
	parent.frmright.document.forms[0].action="PropertyWBList.jsp";
	parent.frmright.document.forms[0].submit();
	}
	function searchcus1(){
    if (document.forms[0].room.checked)
	  parent.frmright.document.forms[0].Room.value=document.cus.findx.value;
    else
