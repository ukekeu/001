...
<tr>
 <td class="<%if(sel.equals("0")){out.print("menuselect3");}else{out.print("selemenu4");}%>" align="center" width=88 height=21>
	  <a href="#" onclick="document.frm.sel.value=0;findSub('AjListS.jsp');"><font color='<%if(sel.equals("0")){out.print("#FFFFFF");}else{out.print("#000000");}%>'>按揭客户</font></a>
	</td>
	<td class="<%if(sel.equals("1")){out.print("menuselect3");}else{out.print("selemenu4");}%>" align="center" width=88 height=21>
	 <a href="#" onclick="document.frm.sel.value=1;findSub('RoomCodeShowC.jsp');"><font color='<%if(sel.equals("1")){out.print("#FFFFFF");}else{out.print("#000000");}%>'>按揭情况</font></a>
	</td>
...
<P align="center"><font size=3><b>按揭销控图</b></font></P>
 <input type=hidden name=cusname value="">
 <input type=hidden name=secname value="">
<center>
<table width="80%" border="0"><tr>
<td bgcolor='#00CCFF'  align="center">未办理按揭</td>
<td bgcolor='#E5C862'  align="center">已办理按揭</td>
</tr>
  </table>
   ...
   <tr> 
	...
	List list9=new LinkedList();//存按揭日期
	...
	String sqlArr="select   r.code as roomcode,r.Room_code,r.saleState,r.Floor,r.Room,r.floormess,o.customer,o.code,r.floorshow,r.floortype,o.ajdate,o.ajbk,o.ajhtno,c.cus_name,o.ajmoney/10000.0 ajmoney  from room r,order_contract o,customer c  where o.state=2  and o.payment like '%按揭%' and c.serialno=o.customer and r.seccode=o.section and o.loft=r.loft and o.building=r.building and o.room_no=r.room_code and r.seccode=";
	...
	%><td align="center" class=FloorC width="1%"><font color="#ffffff"><div id=A<%=String.valueOf(java.lang.Math.abs(i))+1 %>w1><%=i%></div></font></td>
	 ...
	 <a href="#" title="按揭银行：<%=ajbk %>,按揭款：<%=ajmoney %>万元"><%=RoomNo%>&nbsp;<%=cus_name %>&nbsp;按揭款：<%=ajmoney %>万元</a><br><%=ajstate %> 
	 <%}else{ %>&nbsp;<%} %>
	 </td> 
	 <%}
	}%>
