...
if (document.rep.choose.value=="2") window.location="<%=reportAddrs%>tairanSaleCusList1.rpt";
...
if (document.rep.choose.value=="9") window.location="<%=reportAddrs%>sectionDataRpt1.rpt";
