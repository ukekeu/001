...
function insertFact(){
     ...
     function Validate(aForm)
   {
      ...
      if (aForm.signatory.value==""){alert("请输入客户名称");return false;}
...
function check1(aa){
   ...
   if (isNaN(a1)){
	...
	}else{ document.cus1.signatory.value=kh;
	   document.cus1.tk.disabled=true;
	   document.cus1.tk.checked=false;
	}
  ...
  <option value=10>花园/露台款差额</option>
	  ...
	  <tr align="left" > 
        ...
        <td width="25%" align="left"  height="14"  > 
          &nbsp;<input type=text name="FactMoney" size="16" value="<%=ysmoney %>" onblur="check1(document.cus1.FactMoney)" onkeydown="key(document.cus1.curry)" size="10" style="border-style: solid; border-width: 1" ><input type=hidden name=tk value=1 disabled>
        </td>
...
-->	  
    ...
    <tr align="left" > 
	   ...
	   <tr align="left" > 
        <td width="15%" align="left"  height="14" bgcolor="#EBEBEB">&nbsp;客户名称</td>
        <td width="25%" align="left"  colspan="3" height="14"  > 
          &nbsp;<input type=text name=signatory  size=51 value="<%=signatory%>">
		  </td>
 ...
 <table width="100%"  align="center" border="0" cellspacing="0"  cellpadding="0"  class="tablefill">
	 ...
	 <p align="center"> 
            ...
            <input type="button" value="提　交" name="Save" onclick="document.cus1.Save.disabled=true;insertFact();">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
