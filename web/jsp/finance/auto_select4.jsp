...
<br>
	   ...
	   target="_blank">
	    ...
	    <table   cellspacing="1" cellpadding>
                    <tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center">开始日期：</td>
                    ...
                    <tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center">结束日期：</td>
                    ...
                    <tr>
                      <td width="50%" bgcolor="#EAEAEA"  align="center">选择楼盘：</td>
...
<select name="SecNo"  onclick="changebuild(this);fill();" style="width=100;">
					...
					<tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center">选择栋号：</td>
					...
					<tr>
                      <td width="50%" bgcolor="#EAEAEA" align="center">结转类型：</td>
					  <td width="50%" bgcolor="#EAEAEA" align="center" >
