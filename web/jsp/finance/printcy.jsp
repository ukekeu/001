...
if (payment.indexOf("现")>=0)payment1="√";
else if (payment.indexOf("支")>=0)payment2="√";
else if (payment.indexOf("信")>=0||payment.indexOf("机")>=0)payment3="√";
else if (payment.indexOf("其")>=0)payment4="√";
   ...
   if (upperMoney.length()==2)
   {
	...
	//  p10=ldcurry;
 	...
 	String sjcontext="insert into printsksj(customer,payment,context,money1"
	  +",money2,rate,curr,txt,checker,r1,r2,r3,r4,r5,r6,r7,r8,r9,r0,sj_date,out) values('"+cusName+"','"+PayType+"','"+context+"(VIP卡号"+vipno+")"
...
<center>
票据摘要:<input type=text name=zy size=50 value="<%=context+"(VIP卡号"+vipno+")" %>">
<br><br>
