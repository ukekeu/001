...
else if (type.equals("14"))url="cusSk.jsp"; 
...
<br>
	  ...
	  <input type=hidden name="type" value="<%=type %>">
	    <table  cellspacing="1" cellpadding>
                    <tr>
                      <td   align="center"><font  color="#000080">开始日期：</td>
					  <td   align="center"><input onkeydown="key(document.cus.Date1)" title="" size="11" name="Date1"><input title="请选择开始日期" onclick="fPopUpCalendarDlg(Date1);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
                    <tr>
                      <td   align="center"><font  color="#000080">结束日期：</td>
					  <td   align="center"><input onkeydown="key(document.cus.Date2)" title="" size="11" name="Date2"><input title="请选择开始日期" onclick="fPopUpCalendarDlg(Date2);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
					
                    <tr>
                      <td    align="center"><font  color="#000080">选择楼盘：</td>
					  <td    align="center">
...
<select name="SecNo"  onclick="" style="width=110;" onchange="changebuild(this);demeTaxname();">
					...
					<tr>
                      <td   align="center"><font  color="#000080">选择栋号：</td>
					...
					<tr>
                      <td   align="center"><font  color="#000080">房&nbsp;间&nbsp;号：</td>
					  <td   align="center"  ><input type=text size=14 name=room >
					 </td>
					 </tr>
					  <tr>
                      <td    align="center"><font  color="#000080">代收项目：</td>
					  <td    align="center">
				 
<select name="TaxName"   style="width=110;"  >
					      <option value=""></option>
