...
<%
   ...
   <tr valign="top">
    ...
    <img src="../images/minus.gif" border=0 align="absmiddle" hspace="4"  name="uptown_<%=SectionSerialNo%>" onclick="changesrc(this);document.all.T<%=SectionSerialNo%>.style.display=(document.all.T<%=SectionSerialNo%>.style.display=='none')?'block':'none';"><a href="TaxChargesList.jsp?SecNo=<%=SectionSerialNo %>&Loft=&SecName=<%=SectionName%>" target="frmright" ><%=SectionName%></a>
	 </td>
   <tr>
   <td  valign="top">
 ...
 <td id="buil_<%=Loft%>"   onclick="changeclassname(this,'BL2','L2');">
  <img src="../images/document1.gif" border=0 align="absmiddle" hspace="4" ><a href="TaxChargesList.jsp?SecNo=<%=SectionSerialNo %>&Loft=<%=Loft %>&SecName=<%=SectionName%>" target="frmright"  title="单击后在右边查看付款情况" onclick="aad2(s<%=num %>,100);"><%=Loft %></a><img src="../images/h.gif"  name="s<%=num %>"  value="<%=num %>" >
  </td>
  </tr>
   <% 
 ...
 <img src="../images/tree.gif" border=0 align="absmiddle" hspace="4" ><a href="TaxChargesList.jsp?SecNo=<%=SectionSerialNo %>&Loft=<%=Loft %>&SecName=<%=SectionName%>&Build=<%=Build %>" target="frmright"  title='单击后在右边查看付款情况' onclick="aad2(s<%=num %>,100);"><%=Build %></a><img src="../images/h.gif"  name="s<%=num %>"  value="<%=num %>" >
...
<%ViewBean.closeConn();
 ...
 <script language="JavaScript">
	...
	parent.frmright.document.forms[0].action="TaxChargesList.jsp";
