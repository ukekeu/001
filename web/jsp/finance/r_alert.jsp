...
<%
	String changeStr = "select   a.*,b.code,d.cus_name,a.sumprice-a.oldprice c_price,a.jzarea-a.oldarea c_area from ChangRoomR a ,order_contract b,MessageHF c ,customer d where datediff(d,a.ChangeDate,getdate()) <=5 and b.customer=d.SerialNo and b.code=c.order_contract and b.sectionname=a.section and b.loft=a.newloft and b.room_no =a.nowroom and b.floors =a.newfloor    "
