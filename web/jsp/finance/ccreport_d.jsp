...
<body onload="fulldate();setSelectMad2(document.frm.SecNo, '<%= getbyte1(request.getParameter("section")) %>');">
     ...
     <p align="center"><b><font size="3" color="#000080">请选择查询条件 </b>
<br>
	  ...
	  <input type=hidden name="type" value="<%=type %>">
	    <table width="30%" cellspacing="1" cellpadding>
                    <tr>
					  ...
					  <td   align="center"><input onkeydown="key(document.frm.Date1)" title="请选择认购日期" size="11" name="Date1"><input title="请选择开始日期" onclick="fPopUpCalendarDlg(Date1);return false;" type="button" value=".." name="cale"></b></td>
                    </tr>
                    <tr>
                      <td   align="center">结束日期：</td>
					  <td   align="center"><input onkeydown="key(document.frm.Date2)" title="请选择认购日期" size="11" name="Date2"><input title="请选择开始日期" onclick="fPopUpCalendarDlg(Date2);return false;" type="button" value=".." name="cale"></b></td>
                    </tr>
...
<select name="SecNo"  onclick="" style="width=110;" onchange="changebuild(this);">
					...
					<%if (type.equals("1")){%>
					<tr>
                      <td   align="center">核对状态：</td>
					  <td   align="center" >
					 <select name="checkstate"  style="width=110;">
					      <option value="0">所有收款记录</option>
						  <option value="1">已审核收款记录</option>
						   <option value="2">未审核收款记录</option>
							</select>
					</tr> 
					<%}else if (type.equals("7")){%>
					<tr>
                      <td   align="center">核销状态：</td>
					  <td   align="center" >
					 <select name="checkstate"  style="width=110;">
					      <option value="0">所有收款记录</option>
						  <option value="1">已核销票据收款记录</option>
						   <option value="2">未核销票据收款记录</option>
							</select>
					</tr> 
					<%} %>
				</table>
