...
//把当前删除的款转换为合同款的币别金额
  ...
  String deletechecked="true";
	     ...
	     String sqG =" select id ,shouldMoney,yijiao as shouldMoney1  from GatheringRecord where    "
             + " cusno = '" + strCusNo + "' "
             + "  and contactno = '" + contractno + "' and  state<>2  order by shouldQS  desc ";
      ...
      while( rsG.next() ) {
	      ...
	      double shouldMoney=rsG.getDouble("shouldMoney");
		  ...
		  // out.print(shouldMoney1+"aaaa"+strFactMoney1);
			...
			//  out.print("<br>");
		  if (strFactMoney1+shouldMoney1==shouldMoney){
			...
			// out.print(upSQL+"<br>");
			 strFactMoney1=0;
			break;
		  }else if (strFactMoney1+shouldMoney1>shouldMoney){
		     upSQL="update GatheringRecord set state=0,yijiao=0 where "
		     + " cusno = '" + strCusNo + "' "
	         + "  and contactno = '" + contractno + "' and id="+rsG.getString( "id" );
		  ...
		  fBean.executeUpdate( upSQL ) ;
			 out.print(upSQL+"<br>");
		    strFactMoney1=strFactMoney1+shouldMoney1-shouldMoney;
