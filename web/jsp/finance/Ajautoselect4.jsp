	  ...
	  <input type=hidden name="type" value="<%=type %>">
	    <table   cellspacing="1" cellpadding>
                    <tr>
					  ...
					  <td   align="center"><input onkeydown="key(document.cus.VisaDate)" title="请选择认购日期" size="11" name="Date1"><input title="" onclick="fPopUpCalendarDlg(Date1);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
                    <tr>
                      <td   align="center"><font  color="#000080">结束日期：</font></td>
					  <td   align="center"><input onkeydown="key(document.cus.VisaDate)" title="请选择认购日期" size="11" name="Date2"><input title="" onclick="fPopUpCalendarDlg(Date2);return false;" type="button" value=".." name="cale"></b></font></td>
                    </tr>
...
<select name="SecNo"  onclick="" style="width=110;" onchange="changebuild(this);">
					...
					<tr>
                      <td   align="center"><font   color="#000080">房&nbsp;间&nbsp;号:&nbsp;</font></td>
					  <td   align="center"  ><input type=text size=14 name=room >
					 </td>
					 </tr>
					 <%} %>
					  <tr>
                      <td    align="center"><font  color="#000080">日期选择:&nbsp;</font></td>
					  <td    align="center">
					
<select name="datetype"   style="width=110;"  >
					      <option value="0" >签约日期</option>
						 <option value="1">认购日期</option>
						  <option value="2" <%if (request.getParameter("url").equals("4")||request.getParameter("url").equals("2")){out.print("selected");} %>>收款日期</option>
 <option value="3">退款日期</option>
							</select>
					</tr>
					<%if (!request.getParameter("url").equals("4")&&!request.getParameter("url").equals("2")){ %>
 <tr>
                      <td    align="center"><font  color="#000080">是否已认购:&nbsp;</font></td>
					  <td    align="center">
					
<select name="zt"   style="width=110;"  >
					      <option value="0">未认购</option> <option value="1">已认购</option>
