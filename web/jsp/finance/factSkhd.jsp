...
<script language="JavaScript">
	 ...
	 if (getseldocs2()==""){alert("请选择核实的项");return false;}
	   ...
	   if (confirm("确认通过核实？"))
	   openwin("sk_check.jsp?codes="+getseldocs2(),500,200,100,100);
...
<body topmargin="1"  onload="setSelectMad(document.frm.showall,'<%=showall%>');setSelectMad(document.frm.skType,'<%=skType%>');">
 <form method="POST" name="frm" action="factSkhd.jsp">
  <%
 ...
 <br>
  ...
  <td  > 
      ...
      <td  > 
       ...
       <td  > 
        <div align="center"><font color="#FFFFFF">房款金额</font></div>
      </td>
...
sql+="o.payment1,o.date,o.visadate,f.Gather_Date,f.factmoney,f.id,f.checkstate ";
sql+="from order_contract o,customer c,FactGatheringRecord f where";

if (showall.equals("0")){
sql+=" o.customer=c.serialno and o.code=f.contractno and o.state<>3 and  f.cusno=o.customer ";
