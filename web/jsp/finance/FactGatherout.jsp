...
<option value=8>房款差额</option>
 <option value=9>改装款差额</option>
  <option value=10>花园/露台款差额</option>
        ...
        <td width="15%"  align="left" height="23" bgcolor="#EBEBEB">&nbsp;退款日期</td>
	  ...
	  <tr align="left" > 
        <td width="15%" align="left"  height="14" bgcolor="#EBEBEB">&nbsp;退款金额</td>
        ...
        <td width="15%"  align="left" height="23" bgcolor="#EBEBEB">&nbsp;退款币种</td>
        <td width="25%"  align="left" height="23"  > 
      ...
      <tr style="border-style: solid; border-width: 1"> 
        <td width="15%"  align="left" height="23" bgcolor="#EBEBEB">&nbsp;退款方式</td>
        <td width="25%"  align="left" height="23" > 
...
-->	  
    ...
    <tr align="left" > 
        ...
        <td width="15%" align="left"  height="14" bgcolor="#EBEBEB">&nbsp;操作员</td>
        <td width="25%" align="left"  height="14"  >
	   ...
	   <tr align="left" > 
        <td width="15%" align="left"  height="14" bgcolor="#EBEBEB">&nbsp;退款方名称</td>
