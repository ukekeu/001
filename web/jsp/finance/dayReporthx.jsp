  ...
  <tr align="center">
   ...
   ResultSet rs1=ViewBean1.executeQuery(Wheresql);
    while (rs1.next()){
		...
		// 
		  String SQL="SELECT a.state,a.sectionname,a.code,a.loft+room_no room,a.ContractNo,convert(char(10),a.jldate,120) jldate,convert(char(10),a.VisaDate,120) VisaDate,b.cus_name,a.jzarea,a.y_jzarea,a.cj_f,a.unitprice ";
		   SQL+=",a.rmbprice,c.factmoney,c.Bill_Num,c.PayType,c.period,c.checkcancel,c.context jsbak,convert(char(10),c.checkcanceldate,120) checkcanceldate from order_contract a,customer b,factGatheringRecord c where    c.contractno=a.code and a.customer=b.serialno";
         if (!SecNo1.equals(""))
		  SQL+=" and a.section='"+SecNo1+"'";
		 if (!Loft.equals(""))
		  SQL+=" and a.Loft='"+Loft+"' " ;
		   if (okcheckstate.equals("1"))
		   SQL+=" and c.checkcancel=1" ;
		 else    if (okcheckstate.equals("2"))
		   SQL+=" and c.checkcancel=0" ;
		  ...
		  while (rs.next()){
			 ...
			 <tr align="center">
			    <td width="4%"><%=ii %></td>
			    <td width="4%"><%=rs.getString("cus_name") %></td>
			  ...
			  <td width="4%"><%if (checkcancel==1){out.print("已核销");} %><%if (salestate==3){out.print("<font color=red>已退房</font>");} %></td>
        </tr>
...
fk=0;
 ...
 <tr align="center">
  ...
  <td  >&nbsp;<%if (rs.getInt("aj_type")==0){out.print("商货");}else{out.print("公积金");} %> </td>
 ...
 if (!Loft.equals(""))
	SQL+=" and o.Loft='"+Loft+"' " ;
		SQL+="  " ;  
hjarea=0;hjprice=0;xjarea=0;xjprice=0;
