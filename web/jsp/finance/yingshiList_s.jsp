...
orderSQL+=" where o.customer=c.serialno and o.code="+contractno;
 ...
 <td align="left">
  <input type=button name=addlist value="增加明细"   onclick="addpay();"> <input type=button name=modilist value="修改明细"   onclick="editpay();"> <input type=button name=delelist value="删除明细"   onclick="deletepay();"> 
...
%>
    ...
    %>
		 <tr bgcolor="#EBEBEB" align="center">
     <td colspan=2>
    <b>合&nbsp;&nbsp;计:</td><td colspan=5 align="left"> <b><%= curry+fa.getFloat2(yijiao,2)+"("+fa.getFloat2(yijiao/SalePrice*100,2)+"%)"%> </b> </td> 
     <td >
