...
function fx(){
 var choose=document.cus.photo.value;
  if (choose=="3")
  document.cus.action="FinanceFx1.jsp";
 else if (choose=="2")
    document.cus.action="FinanceFx2.jsp";
  document.cus.submit();
}
</script>
<body>
...
<tr><td class=roomleft>&nbsp;图表类型</td><td class=roomright>&nbsp;<select name="photo"><option value=2>直方柱状图</option> 
