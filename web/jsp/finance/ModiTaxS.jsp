...
<input type=hidden name=room value=<%=getbyte2(request.getParameter("room")) %>>
   ...
   <table width="98%"  align="center" border="0" cellspacing="0"  cellpadding="0"  class="tablefill">
	  ...
	  <tr align="left" > 
        ...
        <td width="25%" align="left"  height="14"  > 
          &nbsp;<select name=state style="width : 100"><option value=0 <%if (rs.getInt("state")==0){out.print("selected");} %>>未付清</option><option value=1 <%if (rs.getInt("state")==1){out.print("selected");} %>>已付清</option></select>
        </td>
      </tr>
