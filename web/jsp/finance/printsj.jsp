...
String pr=getbyte1(request.getParameter("pr"));
  ...
  if (!pr.equals("")){
		...
		aBean.executeUpdate("update FactGatheringRecord set printdate=getdate()  where contractno="+contractno);
		...
		rs=aBean.executeQuery("select o.jzarea,o.loft+o.room_no room,c.cus_name,c.sj+' '+c.phone phone,o.payment1 from order_contract o ,customer c where o.customer=c.serialno and o.code="+ contractno);
		 if (rs.next()){
		  customer= rs.getString("cus_name");
		  phone= rs.getString("phone");
		  jzarea= rs.getString("jzarea");
		  room= rs.getString("room");
		  c_payment= rs.getString("payment1");
		 }
		 rs.close();
