...
<p align="center"><font size=3>登录日志</font></p>
...
<tr class=listtitle><td><input type=checkbox name=ch onclick="chhoseData(this.checked);">登录用户</td><td>登录时间</td><td>退出时间</td><td>登录IP</td></tr>
<%String sql="";
