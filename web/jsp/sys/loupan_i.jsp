...
String tname = getbyte2(request.getParameter( "zname" )) ;
%>
...
function lp_add_a()
{
	...
	document.f1.action="loupan_ac.jsp?tid=<%= zid %>&tname=<%=tname %>" ;
	document.f1.submit();
}
...
<form name=f1 method=post>
 ...
 <table border=0 width=100% cellpadding=1 cellspacing=1 class=roomright>
   ...
   <tr>
	...
	<%
	String sql = "select serialno , name from crm_project " ;
 ...
 <p align=center>
     <input type=button value="    确定    "  onclick="lp_add_a()">
