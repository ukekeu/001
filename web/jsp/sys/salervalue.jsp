...
function findSub(para){
 ...
 <table width=100% border="0">
  <tr height="16" bgcolor="#EAEAEA">
   <td align="left">
   <input type=button name=add value="增 加" onclick="if (document.f1.section.value==''){alert('请选择楼盘');return false;}else{openwin1('valueinput.jsp?section='+document.f1.section.value,700,250,100,100);}">&nbsp;
