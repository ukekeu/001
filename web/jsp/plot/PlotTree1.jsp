...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD id=frmTitle vAlign=center noWrap align=middle name="frmTitle"><IFRAME 
      id=BoardTitle 
      style="Z-INDEX: 2; VISIBILITY: inherit; WIDTH: 128px; HEIGHT: 100%" 
      name=BoardTitle src="RoomTree3.jsp" frameBorder=0></IFRAME>
    <TD style="WIDTH: 5pt" bgColor=#dbdbdb>
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0>
        <TBODY>
        <TR><TD style="HEIGHT: 100%" onclick=switchSysBar()><SPAN class=navPoint 
