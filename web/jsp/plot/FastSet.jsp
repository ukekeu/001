...
<%
 String StrSql="select type,codename from CODE "+item+" order by type";
   ResultSet codeRS=null;
   String CodeName[]=new String[20];
   String CodeType[]=new String[20];
...
<script language="JavaScript">
 ...
 {
  opener.document.frm.condition.value=pmregister.condition.value;
