...
<%@ include file="../public_js/CheckPopedom.jsp"%>
	  ...
	  String SqlStr="select Url,CModuleNo,CModuleName  from ModuleCortrol where MModuleNo='H' and CModuleNo in(select ModuleNo from PopedomConrtrol where SellerId='"+userid+"') and nexus='C' order by CModuleNo";
	  ResultSet rs=null;
	  int i=1;
	  try{
